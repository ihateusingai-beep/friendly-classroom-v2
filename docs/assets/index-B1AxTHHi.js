(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const I="fc_progress_";function p(e){try{const t=localStorage.getItem(I+e);return t?JSON.parse(t):{name:e,completedScenarios:[],topicProgress:{emotions:{completed:0,total:0},respect:{completed:0,total:0},honesty:{completed:0,total:0},conflict:{completed:0,total:0}},subjectProgress:{math:{completed:0,total:0},chinese:{completed:0,total:0},english:{completed:0,total:0},science:{completed:0,total:0}},totalMoralScore:0,lastPlayed:null}}catch{return{name:e,completedScenarios:[],topicProgress:{},subjectProgress:{},totalMoralScore:0,lastPlayed:null}}}function P(e){e.lastPlayed=new Date().toISOString().split("T")[0],localStorage.setItem(I+e.name,JSON.stringify(e))}function D(e,t,n,o,i){const a=p(e);return a.completedScenarios.includes(t)||(a.completedScenarios.push(t),a.totalMoralScore=Math.max(0,(a.totalMoralScore||0)+o),a.topicProgress[n]&&a.topicProgress[n].completed++,i&&a.subjectProgress[i]&&a.subjectProgress[i].completed++,P(a)),a}function U(e,t,n){const o=p(e);o.topicProgress[t]?o.topicProgress[t].total=n:o.topicProgress[t]={completed:0,total:n},P(o)}function k(){const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);if(n.startsWith(I))try{e.push(JSON.parse(localStorage.getItem(n)))}catch{}}return e}function X(e){try{const t=JSON.parse(e),n=p(t.name);return t.completedScenarios.forEach(o=>{n.completedScenarios.includes(o)||n.completedScenarios.push(o)}),n.totalMoralScore=Math.max(n.totalMoralScore||0,t.totalMoralScore||0),P(n),{ok:!0}}catch(t){return{ok:!1,error:t.message}}}function J(e){const t=p(e);return JSON.stringify(t,null,2)}function W(e,t){return p(e).completedScenarios.includes(t)}const G=[{id:"emotions",title:"情緒與規範",emoji:"🎭",description:"學習管理情緒、守規矩、尊重他人",creedIds:[1,5,7],color:"#FF6B6B"},{id:"respect",title:"尊重與關懷",emoji:"🤝",description:"學習尊重別人、關心他人、不嘲笑",creedIds:[4,5],color:"#4ECDC4"},{id:"honesty",title:"誠實與責任",emoji:"⚖️",description:"學習誠實面對、勇於承擔責任",creedIds:[2,6],color:"#45B7D1"},{id:"conflict",title:"衝突與求助",emoji:"💪",description:"學習解決衝突、向人求助",creedIds:[2,5,7],color:"#96CEB4"}];function H(e){return G.find(t=>t.id===e)}const q=[{id:1,title:"守法的",text:"我們是守法的：遵守校規，奉公守法"},{id:2,title:"信實的",text:"我們是信實的：誠實負責，不欺騙人"},{id:3,title:"整潔的",text:"我們是整潔的：校服整潔，儀容端正"},{id:4,title:"友愛的",text:"我們是友愛的：關心別人，互相幫助"},{id:5,title:"禮讓的",text:"我們是禮讓的：待人有禮，不易發怒"},{id:6,title:"勤力的",text:"我們是勤力的：上課專心，努力學習"},{id:7,title:"合作的",text:"我們是合作的：遵守規則，積極參與"},{id:8,title:"獨立的",text:"我們是獨立的：自己的事，自己去做"},{id:9,title:"愛護學校的",text:"我們是愛護學校的：愛護公物，保護環境"},{id:10,title:"感恩的",text:"我們是感恩的：尊敬師長，孝順父母"}];function T(e){return q.filter(t=>e.includes(t.id))}function Q(e){return T(e).map(t=>`${t.title}：${t.text}`)}let v=!1,m=!1;function z(e){v=e}function F(){return v}function S(){return{speed:parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),fontSize:parseInt(localStorage.getItem("fc_font_size")||"18"),lineHeight:parseFloat(localStorage.getItem("fc_line_height")||"1.5"),spacing:localStorage.getItem("fc_spacing")||"medium"}}function w(){const e=S(),t={narrow:"8px",medium:"16px",wide:"28px"},n=document.documentElement;n.style.setProperty("--fc-font-size",e.fontSize+"px"),n.style.setProperty("--fc-line-height",e.lineHeight),n.style.setProperty("--fc-spacing",t[e.spacing]||"16px")}function N(){if(typeof speechSynthesis>"u")return null;const e=speechSynthesis.getVoices();let t=e.find(n=>n.lang.startsWith("zh-HK")||n.lang.startsWith("zh-yue"));return t||(t=e.find(n=>n.lang.startsWith("zh"))),t||(t=e.find(n=>n.lang.startsWith("en"))),t||null}function Y(e){if(!v||m)return;speechSynthesis.cancel(),m=!0;const t=S(),n=new SpeechSynthesisUtterance(e);n.voice=N(),n.rate=t.speed,n.pitch=1,n.onend=()=>{m=!1},n.onerror=()=>{m=!1},speechSynthesis.speak(n)}function M(e){if(!v||m)return;speechSynthesis.cancel(),m=!0;const t=S(),n=["A","B","C","D"],o=e.options.map((s,r)=>`${n[r]}。${s.text}`).join("。"),i=`${e.title}。${e.description}。選項：${o}`,a=new SpeechSynthesisUtterance(i);a.voice=N(),a.rate=t.speed,a.onend=()=>{m=!1},a.onerror=()=>{m=!1},speechSynthesis.speak(a)}function A(e){if(!v||m)return;speechSynthesis.cancel(),m=!0;const t=S(),n=e.map(i=>`${i.title}：${i.text}`).join("。"),o=new SpeechSynthesisUtterance(n);o.voice=N(),o.rate=t.speed,o.onend=()=>{m=!1},o.onerror=()=>{m=!1},speechSynthesis.speak(o)}function Z(){localStorage.removeItem("fc_tts_speed"),localStorage.removeItem("fc_font_size"),localStorage.removeItem("fc_line_height"),localStorage.removeItem("fc_spacing"),w()}typeof speechSynthesis<"u"&&(speechSynthesis.onvoiceschanged=()=>speechSynthesis.getVoices());typeof speechSynthesis<"u"&&(speechSynthesis.getVoices(),setTimeout(()=>speechSynthesis.getVoices(),100),setTimeout(()=>speechSynthesis.getVoices(),500));window._fcAudio={speak:Y,speakScenario:M,speakCreeds:A,setEnabled:z,isEnabled:F};window.addEventListener("beforeunload",()=>{m=!1});const j=[{id:"math",title:"數學",emoji:"🎯",color:"#4285F4",bgColor:"#E8F0FE"},{id:"chinese",title:"中文",emoji:"📐",color:"#EA4335",bgColor:"#FCE8E6"},{id:"english",title:"英文",emoji:"🔤",color:"#34A853",bgColor:"#E6F4EA"},{id:"science",title:"常識",emoji:"🔬",color:"#9C27B0",bgColor:"#F3E5F5"}];function y(e){var t;return((t=j.find(n=>n.id===e))==null?void 0:t.color)||"#666"}function ee(e){var t;return((t=j.find(n=>n.id===e))==null?void 0:t.bgColor)||"#f5f5f5"}function C(e){var t;return((t=j.find(n=>n.id===e))==null?void 0:t.title)||""}function f(e){var t;return((t=j.find(n=>n.id===e))==null?void 0:t.emoji)||""}let g=null,u=null,$=[];function R(e){g=e}function te(){return g}function ne(e){$=e}function oe(){return $}function B(e){return $.filter(t=>t.topicId===e)}function V(e){return u=$.find(t=>t.id===e)||null,u}function ae(e,t){const n=u;if(!n)return null;const o=n.options.find(r=>r.id===e);if(!o)return null;let i=0,a="";o.effects.forEach(r=>{i+=r.moralChange||0,r.comment&&(a=r.comment)}),g&&D(g,n.id,n.topicId,i,t);const s=T(n.creedIds||[]);return{option:o,moralChange:i,mainComment:a,creeds:s,creedText:Q(n.creedIds||[])}}function L(e){if(!g)return;const t=B(e);U(g,e,t.length)}function ie(e){const t=y(e),n=ee(e),o=F()?'<button class="btn btn-outline" style="margin-bottom:12px;font-size:0.9em" onclick="FC.testTTS()">🔊 測試發音</button>':"";return`
    <div class="container fade-in">
      ...
      <div class="topic-grid">
        ${[{id:"emotions",emoji:"🎭",title:"情緒與規範",sub:"管理情緒、守規矩",color:"#FF6B6B"},{id:"respect",emoji:"🤝",title:"尊重與關懷",sub:"尊重別人、關心他人",color:"#4ECDC4"},{id:"honesty",emoji:"⚖️",title:"誠實與責任",sub:"誠實面對、勇於承擔",color:"#45B7D1"},{id:"conflict",emoji:"💪",title:"衝突與求助",sub:"解決衝突、向人求助",color:"#96CEB4"}].map(i=>{const a=g?p(g).topicProgress[i.id]||{}:{},s=a.total?Math.round(a.completed/a.total*100):0;return`
  ...
  `}function ce(e,t){const n=H(e),o=B(e),i=y(t);return L(e),`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>${n.emoji} ${n.title}</h2>
        ${t?`<span class="topic-badge" style="background:${i}">${f(t)} ${C(t)}</span>`:""}
      </div>
  ...
  `}function se(e,t){const n=V(e);if(!n)return'<div class="container"><p>場景不存在</p></div>';const o=H(n.topicId),i=y(t);return`
    <div class="container fade-in">
      <div class="page-header">
  ...
  `}function re(e,t){const{option:n,moralChange:o,mainComment:i,creeds:a,creedText:s}=e,r=o>=0,l=y(t);return`
    <div class="container fade-in">
      ${t?`<div style="text-align:center;margin-bottom:8px">
        <span class="topic-badge" style="background:${l}">${f(t)} ${C(t)}</span>
      </div>`:""}
  ...
  `}function le(e){var s;const t=p(g),n=t.totalMoralScore||0,o=((s=t.completedScenarios)==null?void 0:s.length)||0,i=y(e),a=[{id:"math",title:"🎯 數學",color:"#4285F4"},{id:"chinese",title:"📐 中文",color:"#EA4335"},{id:"english",title:"🔤 英文",color:"#34A853"},{id:"science",title:"🔬 常識",color:"#9C27B0"}];return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 我的進度</h2>
        ${e?`<span class="topic-badge" style="background:${i}">${f(e)} ${C(e)}</span>`:""}
      </div>
    ...
    <div class="container fade-in">
      ...
      <div class="card" style="margin-bottom:14px">
        ...
        <div class="setting-row" style="margin-bottom:12px">
          ...
          <div class="toggle ${F()?"on":""}" onclick="FC.toggleVoice(this)"></div>
        </div>
  ...
  `}window.FC.selectStudent=function(e){e!=="其他"&&(R(e),c={...c,student:e,view:"home"},d())};window.FC.addStudent=function(){var n;const e=document.getElementById("new-student-name"),t=(n=e==null?void 0:e.value)==null?void 0:n.trim();t&&(R(t),c={...c,student:t,view:"home"},d())};function Ce(){return`
    <div class="container fade-in">
  ...
  `}function ke(){const e=k();return e.length?`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 老師儀表板</h2>
  ...
  `:`
    ...
    </div>`}window.FC.handleImport=function(e){var o;const t=(o=e.target.files)==null?void 0:o[0];if(!t)return;const n=new FileReader;n.onload=i=>{const a=X(i.target.result);a.ok?(alert("匯入成功！"),O()):alert("匯入失敗："+a.error)},n.readAsText(t)};window.FC.exportAll=function(){const e=k(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),o=document.createElement("a");o.href=n,o.download="全班進度.json",o.click(),URL.revokeObjectURL(n)};window.FC.speak=function(){const e=V(c.scenarioId);e&&M(e)};window.FC.speakOpt=function(e){const t=V(c.scenarioId);if(!t)return;const n=t.options.find(o=>o.id===e);if(n){const{speak:o}=window._fcAudio||{};o&&o(n.text)}};window.FC.speakCreeds=function(){var e;(e=c.resultData)!=null&&e.creeds&&A(c.resultData.creeds)};window.FC.toggleVoice=function(e){const t=!F();z(t),e.classList.toggle("on",t)};window.FC.setFontSize=function(e){localStorage.setItem("fc_font_size",e),w()};window.FC.setLineHeight=function(e){localStorage.setItem("fc_line_height",e),w()};window.FC.setSpacing=function(e){localStorage.setItem("fc_spacing",e),w()};window.FC.setSpeed=function(e){localStorage.setItem("fc_tts_speed",e),document.getElementById("speed-val").textContent=parseFloat(e).toFixed(2)+"x"};window.FC.resetSettings=function(){Z(),d()};window.FC.exportMyData=function(){const e=te();if(!e)return;const t=J(e),n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download=`progress_${e}.json`,i.click(),URL.revokeObjectURL(o)};window.FC.importMyData=function(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{var i;const n=(i=t.target.files)==null?void 0:i[0];if(!n)return;const o=new FileReader;o.onload=a=>{const s=X(a.target.result);alert(s.ok?"匯入成功！":"匯入失敗："+s.error),s.ok&&d()},o.readAsText(n)},e.click()};function Fe(){document.querySelectorAll(".student-name").forEach((e,t)=>{const n=k();n[t]&&(e.textContent=n[t].name)})}function d(){console.log("[FC] render, view:",c.view);let e="";try{switch(c.view){case"student-select":e=ye();break;case"subject-select":e=_e();break;case"login":e=Ce();break;case"teacher":e=ke(),Fe();break;case"home":e=ie(c.subjectId);break;case"topic":e=ce(c.topicId,c.subjectId);break;case"play":e=se(c.scenarioId,c.subjectId);break;case"result":e=re(c.resultData,c.subjectId);break;case"progress":e=le(c.subjectId);break;case"settings":e=de();break;default:e='<div class="container"><p>頁面不存在</p></div>'}console.log("[FC] html length:",e.length),x.innerHTML=e}catch(t){console.error("[FC] RENDER ERROR:",t.message,t.stack),x.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+t.message+`
`+(t.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}}ne(_);try{d(),console.log("[FC] render complete, app innerHTML length:",x.innerHTML.length)}catch(e){console.error("[FC] RENDER ERROR:",e.message,e.stack),x.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+e.message+`
`+(e.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}

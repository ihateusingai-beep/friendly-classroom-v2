(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const S="fc_progress_";function u(e){try{const t=localStorage.getItem(S+e);return t?JSON.parse(t):{name:e,completedScenarios:[],topicProgress:{emotions:{completed:0,total:0},respect:{completed:0,total:0},honesty:{completed:0,total:0},conflict:{completed:0,total:0}},subjectProgress:{math:{completed:0,total:0},chinese:{completed:0,total:0},english:{completed:0,total:0},science:{completed:0,total:0}},totalMoralScore:0,lastPlayed:null}}catch{return{name:e,completedScenarios:[],topicProgress:{},subjectProgress:{},totalMoralScore:0,lastPlayed:null}}}function I(e){e.lastPlayed=new Date().toISOString().split("T")[0],localStorage.setItem(S+e.name,JSON.stringify(e))}function J(e,t,n,o,i){const a=u(e);return a.completedScenarios.includes(t)||(a.completedScenarios.push(t),a.totalMoralScore=Math.max(0,(a.totalMoralScore||0)+o),a.topicProgress[n]&&a.topicProgress[n].completed++,i&&a.subjectProgress[i]&&a.subjectProgress[i].completed++,I(a)),a}function U(e,t,n){const o=u(e);o.topicProgress[t]?o.topicProgress[t].total=n:o.topicProgress[t]={completed:0,total:n},I(o)}function C(){const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);if(n.startsWith(S))try{e.push(JSON.parse(localStorage.getItem(n)))}catch{}}return e}function E(e){try{const t=JSON.parse(e),n=u(t.name);return t.completedScenarios.forEach(o=>{n.completedScenarios.includes(o)||n.completedScenarios.push(o)}),n.totalMoralScore=Math.max(n.totalMoralScore||0,t.totalMoralScore||0),I(n),{ok:!0}}catch(t){return{ok:!1,error:t.message}}}function q(e){const t=u(e);return JSON.stringify(t,null,2)}function G(e,t){return u(e).completedScenarios.includes(t)}const W=[{id:"emotions",title:"情緒與規範",emoji:"🎭",description:"學習管理情緒、守規矩、尊重他人",creedIds:[1,5,7],color:"#FF6B6B"},{id:"respect",title:"尊重與關懷",emoji:"🤝",description:"學習尊重別人、關心他人、不嘲笑",creedIds:[4,5],color:"#4ECDC4"},{id:"honesty",title:"誠實與責任",emoji:"⚖️",description:"學習誠實面對、勇於承擔責任",creedIds:[2,6],color:"#45B7D1"},{id:"conflict",title:"衝突與求助",emoji:"💪",description:"學習解決衝突、向人求助",creedIds:[2,5,7],color:"#96CEB4"}];function P(e){return W.find(t=>t.id===e)}const Q=[{id:1,title:"守法的",text:"我們是守法的：遵守校規，奉公守法"},{id:2,title:"信實的",text:"我們是信實的：誠實負責，不欺騙人"},{id:3,title:"整潔的",text:"我們是整潔的：校服整潔，儀容端正"},{id:4,title:"友愛的",text:"我們是友愛的：關心別人，互相幫助"},{id:5,title:"禮讓的",text:"我們是禮讓的：待人有禮，不易發怒"},{id:6,title:"勤力的",text:"我們是勤力的：上課專心，努力學習"},{id:7,title:"合作的",text:"我們是合作的：遵守規則，積極參與"},{id:8,title:"獨立的",text:"我們是獨立的：自己的事，自己去做"},{id:9,title:"愛護學校的",text:"我們是愛護學校的：愛護公物，保護環境"},{id:10,title:"感恩的",text:"我們是感恩的：尊敬師長，孝順父母"}];function V(e){return Q.filter(t=>e.includes(t.id))}function Y(e){return V(e).map(t=>`${t.title}：${t.text}`)}const X="audio/";let _=!1,p=!1,h=null;function Z(){return{speed:parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),fontSize:parseInt(localStorage.getItem("fc_font_size")||"18"),lineHeight:parseFloat(localStorage.getItem("fc_line_height")||"1.5"),spacing:localStorage.getItem("fc_spacing")||"medium"}}function f(){const e=Z(),t={narrow:"8px",medium:"16px",wide:"28px"},n=document.documentElement;n.style.setProperty("--fc-font-size",e.fontSize+"px"),n.style.setProperty("--fc-line-height",e.lineHeight),n.style.setProperty("--fc-spacing",t[e.spacing]||"16px")}function z(e){_=e}function k(){return _}function A(){p=!1,h&&(h.pause(),h=null)}function T(e){A(),h=new Audio(X+e),h.onended=()=>{p=!1,h=null},h.onerror=()=>{p=!1,h=null},h.play().catch(()=>{p=!1,h=null}),p=!0}function M(e){if(!_||p)return;const t=e.id||e;T(`scenarios/${t}.mp3`)}function R(e){if(!_||p||!e||e.length===0)return;const t=e[0].id||e[0];T(`creeds/creed-${t}.mp3`)}function ee(){localStorage.removeItem("fc_tts_speed"),localStorage.removeItem("fc_font_size"),localStorage.removeItem("fc_line_height"),localStorage.removeItem("fc_spacing"),f()}function te(e){e.forEach(t=>{const n=new Audio(X+"scenarios/"+t+".mp3");n.preload="auto"})}f();window._fcAudio={speakScenario:M,speakCreeds:R,setEnabled:z,isEnabled:k,preloadAudio:te,applyCSS:f};window.addEventListener("beforeunload",()=>{A()});const F=[{id:"math",title:"數學",emoji:"🎯",color:"#4285F4",bgColor:"#E8F0FE"},{id:"chinese",title:"中文",emoji:"📐",color:"#EA4335",bgColor:"#FCE8E6"},{id:"english",title:"英文",emoji:"🔤",color:"#34A853",bgColor:"#E6F4EA"},{id:"science",title:"常識",emoji:"🔬",color:"#9C27B0",bgColor:"#F3E5F5"}];function w(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.color)||"#666"}function ne(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.bgColor)||"#f5f5f5"}function y(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.title)||""}function b(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.emoji)||""}let g=null,x=null,j=[];function B(e){g=e}function oe(){return g}function ae(e){j=e}function ie(){return j}function L(e){return j.filter(t=>t.topicId===e)}function H(e){return x=j.find(t=>t.id===e)||null,x}function ce(e,t){const n=x;if(!n)return null;const o=n.options.find(s=>s.id===e);if(!o)return null;let i=0,a="";o.effects.forEach(s=>{i+=s.moralChange||0,s.comment&&(a=s.comment)}),g&&J(g,n.id,n.topicId,i,t);const r=V(n.creedIds||[]);return{option:o,moralChange:i,mainComment:a,creeds:r,creedText:Y(n.creedIds||[])}}function O(e){if(!g)return;const t=L(e);U(g,e,t.length)}function re(e){const t=w(e),n=ne(e),o=k()?'<button class="btn btn-outline" style="margin-bottom:12px;font-size:0.9em" onclick="FC.testTTS()">🔊 測試發音</button>':"";return`
  ...
  `}function se(e,t){const n=P(e),o=L(e),i=w(t);return O(e),`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>${n.emoji} ${n.title}</h2>
        ${t?`<span class="topic-badge" style="background:${i}">${b(t)} ${y(t)}</span>`:""}
      </div>
  ...
  `}function le(e,t){const n=H(e);if(!n)return'<div class="container"><p>場景不存在</p></div>';const o=P(n.topicId),i=w(t);return`
    <div class="container fade-in">
      <div class="page-header">
  ...
  `}function de(e,t){const{option:n,moralChange:o,mainComment:i,creeds:a,creedText:r}=e,s=o>=0,l=w(t);return`
    <div class="container fade-in">
      ${t?`<div style="text-align:center;margin-bottom:8px">
        <span class="topic-badge" style="background:${l}">${b(t)} ${y(t)}</span>
      </div>`:""}
  ...
  `}function me(e){var r;const t=u(g),n=t.totalMoralScore||0,o=((r=t.completedScenarios)==null?void 0:r.length)||0,i=w(e),a=[{id:"math",title:"🎯 數學",color:"#4285F4"},{id:"chinese",title:"📐 中文",color:"#EA4335"},{id:"english",title:"🔤 英文",color:"#34A853"},{id:"science",title:"🔬 常識",color:"#9C27B0"}];return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 我的進度</h2>
        ${e?`<span class="topic-badge" style="background:${i}">${b(e)} ${y(e)}</span>`:""}
      </div>
  ...
  `}window.FC.selectStudent=function(e){e!=="其他"&&(B(e),c={...c,student:e,view:"home"},d())};window.FC.addStudent=function(){var n;const e=document.getElementById("new-student-name"),t=(n=e==null?void 0:e.value)==null?void 0:n.trim();t&&(B(t),c={...c,student:t,view:"home"},d())};function Fe(){return`
    <div class="container fade-in">
  ...
  `}function $e(){const e=C();return e.length?`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 老師儀表板</h2>

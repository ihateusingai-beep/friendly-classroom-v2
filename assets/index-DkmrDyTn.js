(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const I="fc_progress_";function u(e){try{const t=localStorage.getItem(I+e);return t?JSON.parse(t):{name:e,completedScenarios:[],topicProgress:{emotions:{completed:0,total:0},respect:{completed:0,total:0},honesty:{completed:0,total:0},conflict:{completed:0,total:0}},subjectProgress:{math:{completed:0,total:0},chinese:{completed:0,total:0},english:{completed:0,total:0},science:{completed:0,total:0}},totalMoralScore:0,lastPlayed:null}}catch{return{name:e,completedScenarios:[],topicProgress:{},subjectProgress:{},totalMoralScore:0,lastPlayed:null}}}function P(e){e.lastPlayed=new Date().toISOString().split("T")[0],localStorage.setItem(I+e.name,JSON.stringify(e))}function O(e,t,n,o,i){const a=u(e);return a.completedScenarios.includes(t)||(a.completedScenarios.push(t),a.totalMoralScore=Math.max(0,(a.totalMoralScore||0)+o),a.topicProgress[n]&&a.topicProgress[n].completed++,i&&a.subjectProgress[i]&&a.subjectProgress[i].completed++,P(a)),a}function D(e,t,n){const o=u(e);o.topicProgress[t]?o.topicProgress[t].total=n:o.topicProgress[t]={completed:0,total:n},P(o)}function F(){const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);if(n.startsWith(I))try{e.push(JSON.parse(localStorage.getItem(n)))}catch{}}return e}function X(e){try{const t=JSON.parse(e),n=u(t.name);return t.completedScenarios.forEach(o=>{n.completedScenarios.includes(o)||n.completedScenarios.push(o)}),n.totalMoralScore=Math.max(n.totalMoralScore||0,t.totalMoralScore||0),P(n),{ok:!0}}catch(t){return{ok:!1,error:t.message}}}function U(e){const t=u(e);return JSON.stringify(t,null,2)}function W(e,t){return u(e).completedScenarios.includes(t)}const J=[{id:"emotions",title:"情緒與規範",emoji:"🎭",description:"學習管理情緒、守規矩、尊重他人",creedIds:[1,5,7],color:"#FF6B6B"},{id:"respect",title:"尊重與關懷",emoji:"🤝",description:"學習尊重別人、關心他人、不嘲笑",creedIds:[4,5],color:"#4ECDC4"},{id:"honesty",title:"誠實與責任",emoji:"⚖️",description:"學習誠實面對、勇於承擔責任",creedIds:[2,6],color:"#45B7D1"},{id:"conflict",title:"衝突與求助",emoji:"💪",description:"學習解決衝突、向人求助",creedIds:[2,5,7],color:"#96CEB4"}];function H(e){return J.find(t=>t.id===e)}const G=[{id:1,title:"守法的",text:"我們是守法的：遵守校規，奉公守法"},{id:2,title:"信實的",text:"我們是信實的：誠實負責，不欺騙人"},{id:3,title:"整潔的",text:"我們是整潔的：校服整潔，儀容端正"},{id:4,title:"友愛的",text:"我們是友愛的：關心別人，互相幫助"},{id:5,title:"禮讓的",text:"我們是禮讓的：待人有禮，不易發怒"},{id:6,title:"勤力的",text:"我們是勤力的：上課專心，努力學習"},{id:7,title:"合作的",text:"我們是合作的：遵守規則，積極參與"},{id:8,title:"獨立的",text:"我們是獨立的：自己的事，自己去做"},{id:9,title:"愛護學校的",text:"我們是愛護學校的：愛護公物，保護環境"},{id:10,title:"感恩的",text:"我們是感恩的：尊敬師長，孝順父母"}];function z(e){return G.filter(t=>e.includes(t.id))}function q(e){return z(e).map(t=>`${t.title}：${t.text}`)}let w=!1,m=!1;function T(e){w=e}function p(){return w}function S(){return{speed:parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),fontSize:parseInt(localStorage.getItem("fc_font_size")||"18"),lineHeight:parseFloat(localStorage.getItem("fc_line_height")||"1.5"),spacing:localStorage.getItem("fc_spacing")||"medium"}}function y(){const e=S(),t={narrow:"8px",medium:"16px",wide:"28px"},n=document.documentElement;n.style.setProperty("--fc-font-size",e.fontSize+"px"),n.style.setProperty("--fc-line-height",e.lineHeight),n.style.setProperty("--fc-spacing",t[e.spacing]||"16px")}function N(){if(typeof speechSynthesis>"u")return null;const e=speechSynthesis.getVoices();let t=e.find(n=>n.lang.startsWith("zh-HK")||n.lang.startsWith("zh-yue"));return t||(t=e.find(n=>n.lang.startsWith("zh"))),t||(t=e.find(n=>n.lang.startsWith("en"))),t||null}function Q(e){if(!w||m)return;speechSynthesis.cancel(),m=!0;const t=S(),n=new SpeechSynthesisUtterance(e);n.voice=N(),n.rate=t.speed,n.pitch=1,n.onend=()=>{m=!1},n.onerror=()=>{m=!1},speechSynthesis.speak(n)}function Y(e){if(!w||m)return;speechSynthesis.cancel(),m=!0;const t=S(),n=["A","B","C","D"],o=e.options.map((s,r)=>`${n[r]}。${s.text}`).join("。"),i=`${e.title}。${e.description}。選項：${o}`,a=new SpeechSynthesisUtterance(i);a.voice=N(),a.rate=t.speed,a.onend=()=>{m=!1},a.onerror=()=>{m=!1},speechSynthesis.speak(a)}function M(e){if(!w||m)return;speechSynthesis.cancel(),m=!0;const t=S(),n=e.map(i=>`${i.title}：${i.text}`).join("。"),o=new SpeechSynthesisUtterance(n);o.voice=N(),o.rate=t.speed,o.onend=()=>{m=!1},o.onerror=()=>{m=!1},speechSynthesis.speak(o)}function Z(){localStorage.removeItem("fc_tts_speed"),localStorage.removeItem("fc_font_size"),localStorage.removeItem("fc_line_height"),localStorage.removeItem("fc_spacing"),y()}typeof speechSynthesis<"u"&&(speechSynthesis.onvoiceschanged=()=>speechSynthesis.getVoices());typeof speechSynthesis<"u"&&(speechSynthesis.getVoices(),setTimeout(()=>speechSynthesis.getVoices(),100),setTimeout(()=>speechSynthesis.getVoices(),500));window.FC.forceSpeak=function(e){if(typeof speechSynthesis>"u")return;speechSynthesis.cancel();const t=new SpeechSynthesisUtterance(e);t.voice=ee(),t.rate=parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),t.pitch=1,t.onend=()=>{},t.onerror=()=>{},speechSynthesis.speak(t)};function ee(){if(typeof speechSynthesis>"u")return null;const e=speechSynthesis.getVoices();let t=e.find(n=>n.lang.startsWith("zh-HK")||n.lang.startsWith("zh-yue"));return t||(t=e.find(n=>n.lang.startsWith("zh"))),t||(t=e.find(n=>n.lang.startsWith("en"))),t||null}window._fcAudio={speak:Q,speakScenario:Y,speakCreeds:M,setEnabled:T,isEnabled:p,forceSpeak:window.FC.forceSpeak};window.addEventListener("beforeunload",()=>{m=!1});const j=[{id:"math",title:"數學",emoji:"🎯",color:"#4285F4",bgColor:"#E8F0FE"},{id:"chinese",title:"中文",emoji:"📐",color:"#EA4335",bgColor:"#FCE8E6"},{id:"english",title:"英文",emoji:"🔤",color:"#34A853",bgColor:"#E6F4EA"},{id:"science",title:"常識",emoji:"🔬",color:"#9C27B0",bgColor:"#F3E5F5"}];function C(e){var t;return((t=j.find(n=>n.id===e))==null?void 0:t.color)||"#666"}function te(e){var t;return((t=j.find(n=>n.id===e))==null?void 0:t.bgColor)||"#f5f5f5"}function k(e){var t;return((t=j.find(n=>n.id===e))==null?void 0:t.title)||""}function x(e){var t;return((t=j.find(n=>n.id===e))==null?void 0:t.emoji)||""}let g=null,f=null,$=[];function A(e){g=e}function ne(){return g}function oe(e){$=e}function ae(){return $}function R(e){return $.filter(t=>t.topicId===e)}function V(e){return f=$.find(t=>t.id===e)||null,f}function ie(e,t){const n=f;if(!n)return null;const o=n.options.find(r=>r.id===e);if(!o)return null;let i=0,a="";o.effects.forEach(r=>{i+=r.moralChange||0,r.comment&&(a=r.comment)}),g&&O(g,n.id,n.topicId,i,t);const s=z(n.creedIds||[]);return{option:o,moralChange:i,mainComment:a,creeds:s,creedText:q(n.creedIds||[])}}function B(e){if(!g)return;const t=R(e);D(g,e,t.length)}function ce(e){const t=C(e),n=te(e),o='<button class="btn btn-outline" style="margin-bottom:12px;font-size:0.9em" onclick="FC.testTTS()">🔊 測試發音</button>',i=`<div style="display:flex;align-items:center;justify-content:center;gap:12px;margin:12px 0;padding:12px;background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.05)">
    <span style="font-size:0.9em;color:var(--text-light)">🔊 語音朗讀</span>
    <div class="toggle ${p()?"on":""}" onclick="FC.toggleVoice(this)" style="position:relative;width:48px;height:26px;background:${p()?"var(--primary)":"var(--border)"};border-radius:13px;cursor:pointer;transition:background 0.2s">
      <div style="position:absolute;width:22px;height:22px;background:#fff;border-radius:50%;top:2px;left:${p()?"24px":"2px"};transition:left 0.2s;box-shadow:0 1px 4px rgba(0,0,0,0.2)"></div>
    </div>
    <span style="font-size:0.85em;font-weight:600;color:${p()?"var(--primary)":"var(--text-light)"}">${p()?"開":"關"}</span>
  </div>`;return`
    <div class="container fade-in">
      ...
      <div class="subject-banner" style="background:${n};border:2px solid ${t}">
        <span style="font-size:1.5em">${x(e)}</span>
        <div>
      ...
      <div class="topic-grid">
        ${[{id:"emotions",emoji:"🎭",title:"情緒與規範",sub:"管理情緒、守規矩",color:"#FF6B6B"},{id:"respect",emoji:"🤝",title:"尊重與關懷",sub:"尊重別人、關心他人",color:"#4ECDC4"},{id:"honesty",emoji:"⚖️",title:"誠實與責任",sub:"誠實面對、勇於承擔",color:"#45B7D1"},{id:"conflict",emoji:"💪",title:"衝突與求助",sub:"解決衝突、向人求助",color:"#96CEB4"}].map(a=>{const s=g?u(g).topicProgress[a.id]||{}:{},r=s.total?Math.round(s.completed/s.total*100):0;return`
            <div class="topic-card" style="background:${a.color}" onclick="FC.goTopic('${a.id}')">
              <span class="emoji">${a.emoji}</span>
              <div class="title">${a.title}</div>
              <div class="sub">${a.sub}</div>
              ${g?`
                <div class="progress-bar"><div class="progress-fill" style="width:${r}%"></div></div>
                <div class="sub">${s.completed||0}/${s.total||0} 已完成</div>
              `:""}
            </div>
          `})}
      </div>
  ...
  `}function se(e,t){const n=H(e),o=R(e),i=C(t);return B(e),`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>${n.emoji} ${n.title}</h2>
        ${t?`<span class="topic-badge" style="background:${i}">${x(t)} ${k(t)}</span>`:""}
      </div>
      <p style="color:var(--text-light);margin-bottom:16px">${n.description}</p>

      <ul class="scenario-list">
        ${o.map(a=>{const s=g&&W(g,a.id);return`
  ...
  `}function re(e,t){const n=V(e);if(!n)return'<div class="container"><p>場景不存在</p></div>';const o=H(n.topicId),i=C(t);return`
    <div class="container fade-in">
      <div class="page-header">
      ...
      <div class="options">
        ${n.options.map((a,s)=>{const r=["A","B","C","D"];return`
            <div class="option-card" onclick="FC.choose('${a.id}')">
              <span class="opt-badge">${r[s]||s+1}</span>
  ...
  `}function le(e,t){const{option:n,moralChange:o,mainComment:i,creeds:a,creedText:s}=e,r=o>=0,l=C(t);return`
    <div class="container fade-in">
      ${t?`<div style="text-align:center;margin-bottom:8px">
        <span class="topic-badge" style="background:${l}">${x(t)} ${k(t)}</span>
      </div>`:""}
      <div class="result-card ${r?"good":"bad"}">
        <div class="result-emoji">${r?"🌟":"💪"}</div>
        <div class="comment">${i||"你做出了選擇！"}</div>
        <div class="moral-score">${r?"＋":""}${o} 道德分</div>
      </div>
      ...
      <div class="action-row">
        ...
        <button class="btn btn-outline" onclick="FC.goTopic('${f==null?void 0:f.topicId}')">← 返回主題</button>
      </div>

      <button class="voice-fab" onclick="FC.speakCreeds()" title="朗讀信條">🔊</button>
    </div>
  `}function de(e){var s;const t=u(g),n=t.totalMoralScore||0,o=((s=t.completedScenarios)==null?void 0:s.length)||0,i=C(e),a=[{id:"math",title:"🎯 數學",color:"#4285F4"},{id:"chinese",title:"📐 中文",color:"#EA4335"},{id:"english",title:"🔤 英文",color:"#34A853"},{id:"science",title:"🔬 常識",color:"#9C27B0"}];return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 我的進度</h2>
        ${e?`<span class="topic-badge" style="background:${i}">${x(e)} ${k(e)}</span>`:""}
      </div>
      ...
      ${e?`<div class="card" style="margin-bottom:12px">
        ...
        ${a.map(r=>{var h;const l=((h=t.subjectProgress)==null?void 0:h[r.id])||{},b=l.total?Math.round(l.completed/l.total*100):0;return`
            <div style="margin-bottom:8px">
              ...
              <div style="height:8px;background:var(--border);border-radius:4px;overflow:hidden">
                <div style="height:100%;width:${b}%;background:${r.color};border-radius:4px;transition:width 0.4s"></div>
              </div>
            </div>`}).join("")}
      </div>`:""}

      ${["emotions","respect","honesty","conflict"].map(r=>{const l=t.topicProgress[r]||{},b=l.total?Math.round(l.completed/l.total*100):0,h=H(r);return`
          <div class="card" style="margin-bottom:10px">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">
              <span style="font-size:1.2em">${(h==null?void 0:h.emoji)||""}</span>
              <strong>${(h==null?void 0:h.title)||r}</strong>
              <span style="margin-left:auto;color:var(--text-light)">${l.completed||0}/${l.total||0}</span>
            </div>
            <div style="height:8px;background:var(--border);border-radius:4px;overflow:hidden">
              <div style="height:100%;width:${b}%;background:${(h==null?void 0:h.color)||"var(--primary)"};border-radius:4px;transition:width 0.4s"></div>
            </div>
          </div>
        `}).join("")}
    ...
    <div class="container fade-in">
      ...
      <div class="card" style="margin-bottom:14px">
        ...
        <div class="setting-row" style="margin-bottom:12px">
          ...
          <div class="toggle ${p()?"on":""}" onclick="FC.toggleVoice(this)"></div>
        </div>
  ...
  `}window.FC.selectStudent=function(e){e!=="其他"&&(A(e),c={...c,student:e,view:"home"},d())};window.FC.addStudent=function(){var n;const e=document.getElementById("new-student-name"),t=(n=e==null?void 0:e.value)==null?void 0:n.trim();t&&(A(t),c={...c,student:t,view:"home"},d())};function ke(){return`
    <div class="container fade-in">
  ...
  `}window.FC.doLogin=function(){var t;if(((t=document.getElementById("teacher-pw"))==null?void 0:t.value)==="admin")c={...c,view:"teacher",teacherMode:!0},d();else{const n=document.getElementById("login-error");n&&(n.style.display="block")}};function _e(){return`
  ...
  `}function Fe(){const e=F();return e.length?`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 老師儀表板</h2>
      ...
      <div class="card" style="margin-top:16px">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px">
          ${[{id:"math",label:"🎯",color:"#4285F4"},{id:"chinese",label:"📐",color:"#EA4335"},{id:"english",label:"🔤",color:"#34A853"},{id:"science",label:"🔬",color:"#9C27B0"}].map(t=>{const n=e.reduce((a,s)=>{var r,l;return a+(((l=(r=s.subjectProgress)==null?void 0:r[t.id])==null?void 0:l.completed)||0)},0),o=e.reduce((a,s)=>{var r,l;return a+(((l=(r=s.subjectProgress)==null?void 0:r[t.id])==null?void 0:l.total)||0)},0),i=o?Math.round(n/o*100):0;return`
  ...
  `:`
    ...
    </div>`}window.FC.handleImport=function(e){var o;const t=(o=e.target.files)==null?void 0:o[0];if(!t)return;const n=new FileReader;n.onload=i=>{const a=X(i.target.result);a.ok?(alert("匯入成功！"),L()):alert("匯入失敗："+a.error)},n.readAsText(t)};window.FC.exportAll=function(){const e=F(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),o=document.createElement("a");o.href=n,o.download="全班進度.json",o.click(),URL.revokeObjectURL(n)};window.FC.speak=function(){const e=V(c.scenarioId);e&&window.FC.forceSpeak&&window.FC.forceSpeak(e.title+"。"+e.description)};window.FC.speakOpt=function(e){const t=V(c.scenarioId);if(!t)return;const n=t.options.find(o=>o.id===e);n&&window.FC.forceSpeak&&window.FC.forceSpeak(n.text)};window.FC.speakCreeds=function(){var e;(e=c.resultData)!=null&&e.creeds&&M(c.resultData.creeds)};window.FC.toggleVoice=function(e){const t=!p();T(t),e.classList.toggle("on",t)};window.FC.setFontSize=function(e){localStorage.setItem("fc_font_size",e),y()};window.FC.setLineHeight=function(e){localStorage.setItem("fc_line_height",e),y()};window.FC.setSpacing=function(e){localStorage.setItem("fc_spacing",e),y()};window.FC.setSpeed=function(e){localStorage.setItem("fc_tts_speed",e),document.getElementById("speed-val").textContent=parseFloat(e).toFixed(2)+"x"};window.FC.resetSettings=function(){Z(),d()};window.FC.exportMyData=function(){const e=ne();if(!e)return;const t=U(e),n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download=`progress_${e}.json`,i.click(),URL.revokeObjectURL(o)};window.FC.importMyData=function(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{var i;const n=(i=t.target.files)==null?void 0:i[0];if(!n)return;const o=new FileReader;o.onload=a=>{const s=X(a.target.result);alert(s.ok?"匯入成功！":"匯入失敗："+s.error),s.ok&&d()},o.readAsText(n)},e.click()};function Se(){document.querySelectorAll(".student-name").forEach((e,t)=>{const n=F();n[t]&&(e.textContent=n[t].name)})}function d(){console.log("[FC] render, view:",c.view);let e="";try{switch(c.view){case"student-select":e=Ce();break;case"subject-select":e=_e();break;case"login":e=ke();break;case"teacher":e=Fe(),Se();break;case"home":e=ce(c.subjectId);break;case"topic":e=se(c.topicId,c.subjectId);break;case"play":e=re(c.scenarioId,c.subjectId);break;case"result":e=le(c.resultData,c.subjectId);break;case"progress":e=de(c.subjectId);break;case"settings":e=me();break;default:e='<div class="container"><p>頁面不存在</p></div>'}console.log("[FC] html length:",e.length),v.innerHTML=e}catch(t){console.error("[FC] RENDER ERROR:",t.message,t.stack),v.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+t.message+`
`+(t.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}}oe(_);try{d(),console.log("[FC] render complete, app innerHTML length:",v.innerHTML.length)}catch(e){console.error("[FC] RENDER ERROR:",e.message,e.stack),v.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+e.message+`
`+(e.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}

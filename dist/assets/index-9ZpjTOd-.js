(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const P="fc_progress_";function f(e){try{const t=localStorage.getItem(P+e);return t?JSON.parse(t):{name:e,completedScenarios:[],topicProgress:{emotions:{completed:0,total:0},respect:{completed:0,total:0},honesty:{completed:0,total:0},conflict:{completed:0,total:0}},subjectProgress:{math:{completed:0,total:0},chinese:{completed:0,total:0},english:{completed:0,total:0},science:{completed:0,total:0}},totalMoralScore:0,lastPlayed:null}}catch{return{name:e,completedScenarios:[],topicProgress:{},subjectProgress:{},totalMoralScore:0,lastPlayed:null}}}function H(e){e.lastPlayed=new Date().toISOString().split("T")[0],localStorage.setItem(P+e.name,JSON.stringify(e))}function Q(e,t,n,o,i){const a=f(e);return a.completedScenarios.includes(t)||(a.completedScenarios.push(t),a.totalMoralScore=Math.max(0,(a.totalMoralScore||0)+o),a.topicProgress[n]&&a.topicProgress[n].completed++,i&&a.subjectProgress[i]&&a.subjectProgress[i].completed++,H(a)),a}function Y(e,t,n){const o=f(e);o.topicProgress[t]?o.topicProgress[t].total=n:o.topicProgress[t]={completed:0,total:n},H(o)}function F(){const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);if(n.startsWith(P))try{e.push(JSON.parse(localStorage.getItem(n)))}catch{}}return e}function A(e){try{const t=JSON.parse(e),n=f(t.name);return t.completedScenarios.forEach(o=>{n.completedScenarios.includes(o)||n.completedScenarios.push(o)}),n.totalMoralScore=Math.max(n.totalMoralScore||0,t.totalMoralScore||0),H(n),{ok:!0}}catch(t){return{ok:!1,error:t.message}}}function Z(e){const t=f(e);return JSON.stringify(t,null,2)}function ee(e,t){return f(e).completedScenarios.includes(t)}const te=[{id:"emotions",title:"情緒與規範",emoji:"🎭",description:"學習管理情緒、守規矩、尊重他人",creedIds:[1,5,7],color:"#FF6B6B"},{id:"respect",title:"尊重與關懷",emoji:"🤝",description:"學習尊重別人、關心他人、不嘲笑",creedIds:[4,5],color:"#4ECDC4"},{id:"honesty",title:"誠實與責任",emoji:"⚖️",description:"學習誠實面對、勇於承擔責任",creedIds:[2,6],color:"#45B7D1"},{id:"conflict",title:"衝突與求助",emoji:"💪",description:"學習解決衝突、向人求助",creedIds:[2,5,7],color:"#96CEB4"}];function T(e){return te.find(t=>t.id===e)}const ne=[{id:1,title:"守法的",text:"我們是守法的：遵守校規，奉公守法"},{id:2,title:"信實的",text:"我們是信實的：誠實負責，不欺騙人"},{id:3,title:"整潔的",text:"我們是整潔的：校服整潔，儀容端正"},{id:4,title:"友愛的",text:"我們是友愛的：關心別人，互相幫助"},{id:5,title:"禮讓的",text:"我們是禮讓的：待人有禮，不易發怒"},{id:6,title:"勤力的",text:"我們是勤力的：上課專心，努力學習"},{id:7,title:"合作的",text:"我們是合作的：遵守規則，積極參與"},{id:8,title:"獨立的",text:"我們是獨立的：自己的事，自己去做"},{id:9,title:"愛護學校的",text:"我們是愛護學校的：愛護公物，保護環境"},{id:10,title:"感恩的",text:"我們是感恩的：尊敬師長，孝順父母"}];function K(e){return ne.filter(t=>e.includes(t.id))}function oe(e){return K(e).map(t=>`${t.title}：${t.text}`)}const z="audio/";let j=null;function ae(){return j||(j=new(window.AudioContext||window.webkitAudioContext)),j}function w(e){try{const t=ae(),n=t.currentTime,o=t.createOscillator(),i=t.createGain();o.connect(i),i.connect(t.destination);const a=i.gain;switch(e){case"click":o.frequency.value=800,o.type="sine",a.setValueAtTime(.15,n),a.exponentialRampToValueAtTime(.001,n+.08),o.start(n),o.stop(n+.08);break;case"hover":o.frequency.value=600,o.type="sine",a.setValueAtTime(.06,n),a.exponentialRampToValueAtTime(.001,n+.05),o.start(n),o.stop(n+.05);break;case"success":o.frequency.value=523,o.type="sine",a.setValueAtTime(.18,n),o.start(n),o.frequency.setValueAtTime(659,n+.1),o.frequency.setValueAtTime(784,n+.2),a.exponentialRampToValueAtTime(.001,n+.45),o.stop(n+.45);break;case"fail":o.frequency.value=400,o.type="sine",a.setValueAtTime(.12,n),o.frequency.exponentialRampToValueAtTime(200,n+.3),a.exponentialRampToValueAtTime(.001,n+.3),o.start(n),o.stop(n+.3);break;case"celebrate":[523,659,784].forEach((s,c)=>{const l=t.createOscillator(),d=t.createGain();l.connect(d),d.connect(t.destination),l.frequency.value=s,l.type="sine",d.gain.setValueAtTime(.12,n+c*.08),d.gain.exponentialRampToValueAtTime(.001,n+.6+c*.08),l.start(n+c*.08),l.stop(n+.65+c*.08)});break;case"complete":[523,659,784,1047].forEach((s,c)=>{const l=t.createOscillator(),d=t.createGain();l.connect(d),d.connect(t.destination),l.frequency.value=s,l.type="triangle",d.gain.setValueAtTime(.14,n+c*.07),d.gain.exponentialRampToValueAtTime(.001,n+.5+c*.07),l.start(n+c*.07),l.stop(n+.55+c*.07)});break}}catch(t){console.warn("[FC SFX] Error:",t.message)}}function X(){document.addEventListener("click",e=>{e.target.closest(".btn")&&w("click")}),document.addEventListener("mouseover",e=>{e.target.closest(".btn")&&w("hover")})}let y=!0,h=!1,u=null;function M(){return{speed:parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),fontSize:parseInt(localStorage.getItem("fc_font_size")||"18"),lineHeight:parseFloat(localStorage.getItem("fc_line_height")||"1.5"),spacing:localStorage.getItem("fc_spacing")||"medium"}}function x(){const e=M(),t={narrow:"8px",medium:"16px",wide:"28px"},n=document.documentElement;n.style.setProperty("--fc-font-size",e.fontSize+"px"),n.style.setProperty("--fc-line-height",e.lineHeight),n.style.setProperty("--fc-spacing",t[e.spacing]||"16px")}function R(e){y=e}function _(){return y}function B(){h=!1,u&&(u.pause(),u=null)}function ie(e){B();const t=z+e;console.log("[FC Audio] Playing:",t),u=new Audio(t),u.onended=()=>{h=!1,u=null,console.log("[FC Audio] Done")},u.onerror=n=>{console.error("[FC Audio] Error:",n),h=!1,u=null},u.play().catch(n=>{console.error("[FC Audio] Play failed:",n.message),h=!1,u=null}),h=!0}function D(e){if(console.log("[FC Audio] speakScenario called, enabled:",y,"speaking:",h,"scenario:",e),!y){console.log("[FC Audio] Blocked: voice not enabled");return}if(h){console.log("[FC Audio] Blocked: already speaking");return}const t=(e==null?void 0:e.id)||e,n=(e==null?void 0:e.description)||"";console.log("[FC Audio] Playing scenario:",t),O(n)}function L(e){if(!y||h||!e||e.length===0)return;const t=e[0].id||e[0];ie(`creeds/creed-${t}.mp3`)}function O(e){var i,a,s;if(!e)return;h&&((i=window.speechSynthesis)==null||i.cancel());const t=new SpeechSynthesisUtterance(e);t.lang="zh-HK",t.rate=M().speed||.85,t.pitch=1;const n=((a=window.speechSynthesis)==null?void 0:a.getVoices())||[],o=n.find(c=>c.lang==="zh-HK")||n.find(c=>c.lang==="zh-TW")||n.find(c=>c.lang==="zh-CN")||n.find(c=>c.lang.includes("zh"))||n[0];o&&(t.voice=o,console.log("[FC TTS] Voice:",o.name)),t.onstart=()=>{h=!0,console.log("[FC TTS] Speaking:",e.slice(0,30))},t.onend=()=>{h=!1,console.log("[FC TTS] Done")},t.onerror=c=>{h=!1,console.error("[FC TTS] Error:",c.error),c.error==="not-allowed"&&console.log("[FC TTS] Fallback to MP3...")},(s=window.speechSynthesis)==null||s.speak(t)}function ce(){localStorage.removeItem("fc_tts_speed"),localStorage.removeItem("fc_font_size"),localStorage.removeItem("fc_line_height"),localStorage.removeItem("fc_spacing"),x()}function re(e){e.forEach(t=>{const n=new Audio(z+"scenarios/"+t+".mp3");n.preload="auto"})}x();window._fcAudio={speakScenario:D,speakCreeds:L,speak:O,setEnabled:R,isEnabled:_,preloadAudio:re,applyCSS:x,playSFX:w,initSFX:X};window.addEventListener("beforeunload",()=>{B()});const S=[{id:"math",title:"數學",emoji:"🎯",color:"#4285F4",bgColor:"#E8F0FE"},{id:"chinese",title:"中文",emoji:"📐",color:"#EA4335",bgColor:"#FCE8E6"},{id:"english",title:"英文",emoji:"🔤",color:"#34A853",bgColor:"#E6F4EA"},{id:"science",title:"常識",emoji:"🔬",color:"#9C27B0",bgColor:"#F3E5F5"}];function C(e){var t;return((t=S.find(n=>n.id===e))==null?void 0:t.color)||"#666"}function se(e){var t;return((t=S.find(n=>n.id===e))==null?void 0:t.bgColor)||"#f5f5f5"}function k(e){var t;return((t=S.find(n=>n.id===e))==null?void 0:t.title)||""}function v(e){var t;return((t=S.find(n=>n.id===e))==null?void 0:t.emoji)||""}let p=null,b=null,$=[];function q(e){p=e}function le(){return p}function de(e){$=e}function me(){return $}function U(e){return $.filter(t=>t.topicId===e)}function E(e){return b=$.find(t=>t.id===e)||null,b}function ge(e,t){const n=b;if(!n)return null;const o=n.options.find(c=>c.id===e);if(!o)return null;let i=0,a="";o.effects.forEach(c=>{i+=c.moralChange||0,c.comment&&(a=c.comment)}),p&&Q(p,n.id,n.topicId,i,t);const s=K(n.creedIds||[]);return{option:o,moralChange:i,mainComment:a,creeds:s,creedText:oe(n.creedIds||[]),scenarioImage:n.image||null,scenarioTitle:n.title||"",outcomeImage:`assets/images/outcomes/${n.id}_opt${n.options.findIndex(c=>c.id===e)+1}.png`}}function J(e){if(!p)return;const t=U(e);Y(p,e,t.length)}function he(e){const t=C(e),n=se(e),o=_()?'<button class="btn btn-outline" style="margin-bottom:12px;font-size:0.9em" onclick="FC.testTTS()">🔊 測試發音</button>':"";return`
    <div class="container fade-in">
      ...
      <div class="subject-banner" style="background:${n};border:2px solid ${t}">
        <span style="font-size:1.5em">${v(e)}</span>
        <div>
          <div style="font-weight:600;color:${t}">${k(e)}學模擬練習</div>
      ...
      <div class="topic-grid">
        ${[{id:"emotions",emoji:"🎭",title:"情緒與規範",sub:"管理情緒、守規矩",color:"#FF6B6B"},{id:"respect",emoji:"🤝",title:"尊重與關懷",sub:"尊重別人、關心他人",color:"#4ECDC4"},{id:"honesty",emoji:"⚖️",title:"誠實與責任",sub:"誠實面對、勇於承擔",color:"#45B7D1"},{id:"conflict",emoji:"💪",title:"衝突與求助",sub:"解決衝突、向人求助",color:"#96CEB4"}].map(i=>{const a=p?f(p).topicProgress[i.id]||{}:{},s=a.total?Math.round(a.completed/a.total*100):0;return`
            <div class="topic-card" style="background:${i.color}" onclick="FC.goTopic('${i.id}')">
              ...
              ${p?`
                ...
                <div class="sub">${a.completed||0}/${a.total||0} 已完成</div>
              `:""}
            </div>
          `})}
      </div>
  ...
  `}function pe(e,t){const n=T(e),o=U(e),i=C(t);return J(e),`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>${n.emoji} ${n.title}</h2>
        ${t?`<span class="topic-badge" style="background:${i}">${v(t)} ${k(t)}</span>`:""}
      </div>
      <p style="color:var(--text-light);margin-bottom:16px">${n.description}</p>

      <ul class="scenario-list">
        ${o.map(a=>{const s=p&&ee(p,a.id);return`
            <li class="scenario-item ${s?"completed":""}" onclick="FC.play('${a.id}')">
              <div class="check">${s?"✓":""}</div>
              <div class="info">
                <div class="title">${a.title}</div>
                <div class="sub">${a.background||""}</div>
              </div>
  ...
  `}function ue(e,t){const n=E(e);if(!n)return'<div class="container"><p>場景不存在</p></div>';const o=T(n.topicId),i=C(t);return`
    <div class="container fade-in">
      <div class="page-header">
  ...
  `}function fe(e,t){const{option:n,moralChange:o,mainComment:i,creeds:a,creedText:s,scenarioImage:c,scenarioTitle:l}=e,d=o>=0,g=C(t);return`
    <div class="container fade-in" id="result-root">
      ${t?`<div style="text-align:center;margin-bottom:8px">
        <span class="topic-badge" style="background:${g}">${v(t)} ${k(t)}</span>
      </div>`:""}
      ${c?`
      <div class="scenario-image-wrap" style="max-height:180px;margin-bottom:16px;border-radius:16px;overflow:hidden">
        <img src="${c}" alt="${l}" style="width:100%;max-height:180px;object-fit:cover" />
      </div>`:""}
      <div class="result-card ${d?"good":"bad"}" id="result-card">
        <div class="result-emoji">${d?"🌟":"💪"}</div>
        <div class="comment">${i||"你做出了選擇！"}</div>
        <div class="moral-score">${d?"＋":""}${o} 道德分</div>
      </div>
      ...
      <div class="creed-show">
        ...
        <div class="items">
          ${(s||[]).map(W=>`<div class="item">${W}</div>`).join("")}
        </div>
      </div>
      ...
      <div class="action-row">
        ...
        <button class="btn btn-outline" onclick="FC.goTopic('${b==null?void 0:b.topicId}')">← 返回主題</button>
      </div>

      <button class="voice-fab" onclick="FC.speakCreeds()" title="朗讀信條">🔊</button>
      <div class="footer" style="text-align:center;padding:16px;font-size:14px;color:var(--text-light);border-top:1px solid var(--border);margin-top:auto">© Ken Cheng 製作</div>
    </div>
  `}function xe(e){var s;const t=f(p),n=t.totalMoralScore||0,o=((s=t.completedScenarios)==null?void 0:s.length)||0,i=C(e),a=[{id:"math",title:"🎯 數學",color:"#4285F4"},{id:"chinese",title:"📐 中文",color:"#EA4335"},{id:"english",title:"🔤 英文",color:"#34A853"},{id:"science",title:"🔬 常識",color:"#9C27B0"}];return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 我的進度</h2>
        ${e?`<span class="topic-badge" style="background:${i}">${v(e)} ${k(e)}</span>`:""}
      </div>
      ...
      ${e?`<div class="card" style="margin-bottom:12px">
        ...
        ${a.map(c=>{var g;const l=((g=t.subjectProgress)==null?void 0:g[c.id])||{},d=l.total?Math.round(l.completed/l.total*100):0;return`
            <div style="margin-bottom:8px">
              <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                <span style="color:${c.color};font-weight:600">${c.title}</span>
                <span style="color:var(--text-light)">${l.completed||0}/${l.total||0}</span>
              </div>
              <div style="height:8px;background:var(--border);border-radius:4px;overflow:hidden">
                <div style="height:100%;width:${d}%;background:${c.color};border-radius:4px;transition:width 0.4s"></div>
              </div>
            </div>`}).join("")}
      </div>`:""}

      ${["emotions","respect","honesty","conflict"].map(c=>{const l=t.topicProgress[c]||{},d=l.total?Math.round(l.completed/l.total*100):0,g=T(c);return`
          <div class="card" style="margin-bottom:10px">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">
              <span style="font-size:1.2em">${(g==null?void 0:g.emoji)||""}</span>
              <strong>${(g==null?void 0:g.title)||c}</strong>
              <span style="margin-left:auto;color:var(--text-light)">${l.completed||0}/${l.total||0}</span>
            </div>
            <div style="height:8px;background:var(--border);border-radius:4px;overflow:hidden">
              <div style="height:100%;width:${d}%;background:${(g==null?void 0:g.color)||"var(--primary)"};border-radius:4px;transition:width 0.4s"></div>
            </div>
          </div>
        `}).join("")}
  ...
  `}function be(){const e=localStorage.getItem("fc_tts_speed")||"0.85",t=localStorage.getItem("fc_font_size")||"18",n=localStorage.getItem("fc_line_height")||"1.5",o=localStorage.getItem("fc_spacing")||"medium",i=t<=18?"小":t<=22?"中":"大";return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>⚙️ 個人化設定</h2>
      ...
      <div class="card" style="margin-bottom:14px">
        ...
        <div class="setting-row" style="margin-bottom:12px">
          ...
          <div class="toggle ${_()?"on":""}" data-key="voice" onclick="FC.toggleVoice(this)"></div>
        </div>
      ...
      <div class="card" style="margin-bottom:14px">
        ...
        <div style="margin-bottom:12px">
          <div style="display:flex;justify-content:space-between;margin-bottom:6px">
            <strong>字體大小</strong>
            <span class="val-label" style="color:var(--primary);font-weight:600" data-for="fs">${i}</span>
          </div>
  ...
  `}window.FC.selectStudent=function(e){e!=="其他"&&(q(e),r={...r,student:e,view:"home"},m())};window.FC.addStudent=function(){var n;const e=document.getElementById("new-student-name"),t=(n=e==null?void 0:e.value)==null?void 0:n.trim();t&&(q(t),r={...r,student:t,view:"home"},m())};function Ve(){return`
    <div class="container fade-in">
  ...
  `}window.FC.doLogin=function(){var t;if(((t=document.getElementById("teacher-pw"))==null?void 0:t.value)==="admin")r={...r,view:"teacher",teacherMode:!0},m();else{const n=document.getElementById("login-error");n&&(n.style.display="block")}};function Ne(){return`
  ...
  `}function Ae(){const e=F();return e.length?`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 老師儀表板</h2>
      ...
      <div class="teacher-panel">
        <h2>👥 學生總覽</h2>
        <div class="subtitle">共 ${e.length} 位學生</div>
      </div>

      <div style="display:flex;flex-direction:column;gap:10px">
        ${e.map(t=>{var s;const n=t.totalMoralScore||0,o=((s=t.completedScenarios)==null?void 0:s.length)||0,i=TEACHER_EMOJI[t.name]||"👤",a=n>=200?"🌟":n>=100?"⭐":n>=50?"✨":"💫";return`
          <div class="student-row">
            <div class="avatar">${i}</div>
            <div class="info">
              <div class="name">${t.name}</div>
              <div class="meta">完成 ${o} 個場景 · 最近 ${t.lastPlayed||"—"}</div>
            </div>
            <div class="stat-badge">
              <div class="num" style="color:${n>=100?"#52c41a":"var(--text)"}">${n}</div>
              <div class="label">道德分</div>
            </div>
            <div style="font-size:1.2em">${a}</div>
          </div>`}).join("")}
      </div>
      ...
      <div class="card" style="margin-top:16px">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px">
          ${[{id:"math",label:"🎯",color:"#4285F4"},{id:"chinese",label:"📐",color:"#EA4335"},{id:"english",label:"🔤",color:"#34A853"},{id:"science",label:"🔬",color:"#9C27B0"}].map(t=>{const n=e.reduce((a,s)=>{var c,l;return a+(((l=(c=s.subjectProgress)==null?void 0:c[t.id])==null?void 0:l.completed)||0)},0),o=e.reduce((a,s)=>{var c,l;return a+(((l=(c=s.subjectProgress)==null?void 0:c[t.id])==null?void 0:l.total)||0)},0),i=o?Math.round(n/o*100):0;return`
              <div style="background:${t.color}18;border:2px solid ${t.color};border-radius:12px;padding:12px;text-align:center">
                <div style="font-size:1.5em;margin-bottom:4px">${t.label}</div>
                <div style="font-weight:700;font-size:1.1em;color:${t.color}">${n}/${o}</div>
                <div style="height:6px;background:#eee;border-radius:3px;margin-top:6px;overflow:hidden">
                  <div style="height:100%;width:${i}%;background:${t.color};border-radius:3px"></div>
                </div>
              </div>`}).join("")}
        </div>
      </div>
  ...
  `:`
    <div class="container fade-in">
      ...
      <div class="footer" style="text-align:center;padding:16px;font-size:14px;color:var(--text-light);border-top:1px solid var(--border);margin-top:auto">© Ken Cheng 製作</div>
    </div>`}window.FC.handleImport=function(e){var o;const t=(o=e.target.files)==null?void 0:o[0];if(!t)return;const n=new FileReader;n.onload=i=>{const a=A(i.target.result);a.ok?(alert("匯入成功！"),G()):alert("匯入失敗："+a.error)},n.readAsText(t)};window.FC.exportAll=function(){const e=F(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),o=document.createElement("a");o.href=n,o.download="全班進度.json",o.click(),URL.revokeObjectURL(n)};window.FC.speak=function(){const e=E(r.scenarioId);e&&D(e)};window.FC.speakOpt=function(e){const t=E(r.scenarioId);if(!t)return;const n=t.options.find(o=>o.id===e);if(n){const{speak:o}=window._fcAudio||{};o&&o(n.text)}};window.FC.speakCreeds=function(){var e;(e=r.resultData)!=null&&e.creeds&&L(r.resultData.creeds)};window.FC.toggleVoice=function(e){const t=!_();R(t),e&&e.classList.toggle("on",t),t&&!localStorage.getItem("fc_voice_seen")&&localStorage.setItem("fc_voice_seen","1")};window.FC.setFontSize=function(e){localStorage.setItem("fc_font_size",e),x();const t=document.querySelector('[data-for="fs"]');t&&(t.textContent=e<=18?"小":e<=22?"中":"大")};window.FC.setLineHeight=function(e){localStorage.setItem("fc_line_height",e),x();const t=document.querySelector('[data-for="lh"]');t&&(t.textContent=parseFloat(e).toFixed(1))};window.FC.setSpacing=function(e){localStorage.setItem("fc_spacing",e),x(),["narrow","medium","wide"].forEach(t=>{const n=document.getElementById("sp-"+t);n&&(n.className="btn "+(t===e?"btn-primary":"btn-outline"))})};window.FC.setSpeed=function(e){localStorage.setItem("fc_tts_speed",e);const t=document.querySelector('[data-for="speed"]');t&&(t.textContent=parseFloat(e).toFixed(2)+"x")};window.FC.resetSettings=function(){ce(),m()};window.FC.exportMyData=function(){const e=le();if(!e)return;const t=Z(e),n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download=`progress_${e}.json`,i.click(),URL.revokeObjectURL(o)};window.FC.importMyData=function(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{var i;const n=(i=t.target.files)==null?void 0:i[0];if(!n)return;const o=new FileReader;o.onload=a=>{const s=A(a.target.result);alert(s.ok?"匯入成功！":"匯入失敗："+s.error),s.ok&&m()},o.readAsText(n)},e.click()};function Ke(){document.querySelectorAll(".student-name").forEach((e,t)=>{const n=F();n[t]&&(e.textContent=n[t].name)})}function m(){let e="";try{switch(r.view){case"student-select":e=Ee();break;case"subject-select":e=Ne();break;case"login":e=Ve();break;case"teacher":e=Ae(),Ke();break;case"home":e=he(r.subjectId);break;case"topic":e=pe(r.topicId,r.subjectId);break;case"play":e=ue(r.scenarioId,r.subjectId);break;case"result":e=fe(r.resultData,r.subjectId);break;case"progress":e=xe(r.subjectId);break;case"settings":e=be();break;default:e='<div class="container"><p>頁面不存在</p></div>'}I.innerHTML=e}catch(t){console.error("RENDER ERROR:",t.message,t.stack),I.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+t.message+`
`+(t.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}}de(ve);try{m()}catch(e){console.error("RENDER ERROR:",e.message,e.stack),I.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+e.message+`
`+(e.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}

(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();const S="fc_progress_";function p(e){try{const t=localStorage.getItem(S+e);return t?JSON.parse(t):{name:e,completedScenarios:[],topicProgress:{emotions:{completed:0,total:0},respect:{completed:0,total:0},honesty:{completed:0,total:0},conflict:{completed:0,total:0}},subjectProgress:{math:{completed:0,total:0},chinese:{completed:0,total:0},english:{completed:0,total:0},science:{completed:0,total:0}},totalMoralScore:0,lastPlayed:null}}catch{return{name:e,completedScenarios:[],topicProgress:{},subjectProgress:{},totalMoralScore:0,lastPlayed:null}}}function $(e){e.lastPlayed=new Date().toISOString().split("T")[0],localStorage.setItem(S+e.name,JSON.stringify(e))}function O(e,t,n,o,a){const i=p(e);return i.completedScenarios.includes(t)||(i.completedScenarios.push(t),i.totalMoralScore=Math.max(0,(i.totalMoralScore||0)+o),i.topicProgress[n]&&i.topicProgress[n].completed++,a&&i.subjectProgress[a]&&i.subjectProgress[a].completed++,$(i)),i}function D(e,t,n){const o=p(e);o.topicProgress[t]?o.topicProgress[t].total=n:o.topicProgress[t]={completed:0,total:n},$(o)}function _(){const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);if(n.startsWith(S))try{e.push(JSON.parse(localStorage.getItem(n)))}catch{}}return e}function V(e){try{const t=JSON.parse(e),n=p(t.name);return t.completedScenarios.forEach(o=>{n.completedScenarios.includes(o)||n.completedScenarios.push(o)}),n.totalMoralScore=Math.max(n.totalMoralScore||0,t.totalMoralScore||0),$(n),{ok:!0}}catch(t){return{ok:!1,error:t.message}}}function U(e){const t=p(e);return JSON.stringify(t,null,2)}function J(e,t){return p(e).completedScenarios.includes(t)}const W=[{id:"emotions",title:"情緒與規範",emoji:"🎭",description:"學習管理情緒、守規矩、尊重他人",creedIds:[1,5,7],color:"#FF6B6B"},{id:"respect",title:"尊重與關懷",emoji:"🤝",description:"學習尊重別人、關心他人、不嘲笑",creedIds:[4,5],color:"#4ECDC4"},{id:"honesty",title:"誠實與責任",emoji:"⚖️",description:"學習誠實面對、勇於承擔責任",creedIds:[2,6],color:"#45B7D1"},{id:"conflict",title:"衝突與求助",emoji:"💪",description:"學習解決衝突、向人求助",creedIds:[2,5,7],color:"#96CEB4"}];function I(e){return W.find(t=>t.id===e)}const G=[{id:1,title:"守法的",text:"我們是守法的：遵守校規，奉公守法"},{id:2,title:"信實的",text:"我們是信實的：誠實負責，不欺騙人"},{id:3,title:"整潔的",text:"我們是整潔的：校服整潔，儀容端正"},{id:4,title:"友愛的",text:"我們是友愛的：關心別人，互相幫助"},{id:5,title:"禮讓的",text:"我們是禮讓的：待人有禮，不易發怒"},{id:6,title:"勤力的",text:"我們是勤力的：上課專心，努力學習"},{id:7,title:"合作的",text:"我們是合作的：遵守規則，積極參與"},{id:8,title:"獨立的",text:"我們是獨立的：自己的事，自己去做"},{id:9,title:"愛護學校的",text:"我們是愛護學校的：愛護公物，保護環境"},{id:10,title:"感恩的",text:"我們是感恩的：尊敬師長，孝順父母"}];function K(e){return G.filter(t=>e.includes(t.id))}function q(e){return K(e).map(t=>`${t.title}：${t.text}`)}let k=!1,g=!1;function Q(e){k=e}function P(){return k}function H(){return{speed:parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),fontSize:parseInt(localStorage.getItem("fc_font_size")||"18"),lineHeight:parseFloat(localStorage.getItem("fc_line_height")||"1.5"),spacing:localStorage.getItem("fc_spacing")||"medium"}}function v(){const e=H(),t={narrow:"8px",medium:"16px",wide:"28px"},n=document.documentElement;n.style.setProperty("--fc-font-size",e.fontSize+"px"),n.style.setProperty("--fc-line-height",e.lineHeight),n.style.setProperty("--fc-spacing",t[e.spacing]||"16px")}function X(){if(typeof speechSynthesis>"u")return null;const e=speechSynthesis.getVoices();let t=e.find(n=>n.lang.startsWith("zh-HK")||n.lang.startsWith("zh-yue"));return t||(t=e.find(n=>n.lang.startsWith("zh"))),t||(t=e.find(n=>n.lang.startsWith("en"))),t||null}function z(e){if(!k||g)return;speechSynthesis.cancel(),g=!0;const t=H(),n=["A","B","C","D"],o=e.options.map((r,s)=>`${n[s]}。${r.text}`).join("。"),a=`${e.title}。${e.description}。選項：${o}`,i=new SpeechSynthesisUtterance(a);i.voice=X(),i.rate=t.speed,i.onend=()=>{g=!1},i.onerror=()=>{g=!1},speechSynthesis.speak(i)}function Y(e){if(!k||g)return;speechSynthesis.cancel(),g=!0;const t=H(),n=e.map(a=>`${a.title}：${a.text}`).join("。"),o=new SpeechSynthesisUtterance(n);o.voice=X(),o.rate=t.speed,o.onend=()=>{g=!1},o.onerror=()=>{g=!1},speechSynthesis.speak(o)}function Z(){localStorage.removeItem("fc_tts_speed"),localStorage.removeItem("fc_font_size"),localStorage.removeItem("fc_line_height"),localStorage.removeItem("fc_spacing"),v()}typeof speechSynthesis<"u"&&(speechSynthesis.onvoiceschanged=()=>speechSynthesis.getVoices());window.addEventListener("beforeunload",()=>{g=!1});const F=[{id:"math",title:"數學",emoji:"🎯",color:"#4285F4",bgColor:"#E8F0FE"},{id:"chinese",title:"中文",emoji:"📐",color:"#EA4335",bgColor:"#FCE8E6"},{id:"english",title:"英文",emoji:"🔤",color:"#34A853",bgColor:"#E6F4EA"},{id:"science",title:"常識",emoji:"🔬",color:"#9C27B0",bgColor:"#F3E5F5"}];function w(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.color)||"#666"}function ee(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.bgColor)||"#f5f5f5"}function y(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.title)||""}function f(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.emoji)||""}let h=null,u=null,j=[];function M(e){h=e}function T(){return h}function te(e){j=e}function ne(){return j}function R(e){return j.filter(t=>t.topicId===e)}function A(e){return u=j.find(t=>t.id===e)||null,u}function oe(e,t){const n=u;if(!n)return null;const o=n.options.find(s=>s.id===e);if(!o)return null;let a=0,i="";o.effects.forEach(s=>{a+=s.moralChange||0,s.comment&&(i=s.comment)}),h&&O(h,n.id,n.topicId,a,t);const r=K(n.creedIds||[]);return{option:o,moralChange:a,mainComment:i,creeds:r,creedText:q(n.creedIds||[])}}function B(e){if(!h)return;const t=R(e);D(h,e,t.length)}function ae(e){const t=w(e),n=ee(e);return`
    <div class="container fade-in">
      ...
      <div class="topic-grid">
        ${[{id:"emotions",emoji:"🎭",title:"情緒與規範",sub:"管理情緒、守規矩",color:"#FF6B6B"},{id:"respect",emoji:"🤝",title:"尊重與關懷",sub:"尊重別人、關心他人",color:"#4ECDC4"},{id:"honesty",emoji:"⚖️",title:"誠實與責任",sub:"誠實面對、勇於承擔",color:"#45B7D1"},{id:"conflict",emoji:"💪",title:"衝突與求助",sub:"解決衝突、向人求助",color:"#96CEB4"}].map(o=>{const a=h?p(h).topicProgress[o.id]||{}:{},i=a.total?Math.round(a.completed/a.total*100):0;return`
            <div class="topic-card" style="background:${o.color}" onclick="FC.goTopic('${o.id}')">
  ...
  `}function ie(e,t){const n=I(e),o=R(e),a=w(t);return B(e),`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>${n.emoji} ${n.title}</h2>
        ${t?`<span class="topic-badge" style="background:${a}">${f(t)} ${y(t)}</span>`:""}
      </div>
      <p style="color:var(--text-light);margin-bottom:16px">${n.description}</p>

      <ul class="scenario-list">
        ${o.map(i=>{const r=h&&J(h,i.id);return`
            <li class="scenario-item ${r?"completed":""}" onclick="FC.play('${i.id}')">
              <div class="check">${r?"✓":""}</div>
              <div class="info">
                <div class="title">${i.title}</div>
                <div class="sub">${i.background||""}</div>
              </div>
  ...
  `}function ce(e,t){const n=A(e);if(!n)return'<div class="container"><p>場景不存在</p></div>';const o=I(n.topicId),a=w(t);return`
    <div class="container fade-in">
      <div class="page-header">
      ...
      <div class="options">
        ${n.options.map((i,r)=>{const s=["A","B","C","D"];return`
            <button class="option-btn" onclick="FC.choose('${i.id}')">
              <span class="opt-id">${s[r]||r+1}</span>
              ${i.text}
            </button>
          `})}
      </div>
  ...
  `}function re(e,t){const{option:n,moralChange:o,mainComment:a,creeds:i,creedText:r}=e,s=o>=0,l=w(t);return`
    <div class="container fade-in">
      ...
      <div class="result-card ${s?"good":"bad"}">
        <div class="comment">${a||"你做出了選擇！"}</div>
        <div class="moral">${s?"＋":""}${o} 道德分</div>
      </div>
  ...
  `}function se(e){var r;const t=p(h),n=t.totalMoralScore||0,o=((r=t.completedScenarios)==null?void 0:r.length)||0,a=w(e),i=[{id:"math",title:"🎯 數學",color:"#4285F4"},{id:"chinese",title:"📐 中文",color:"#EA4335"},{id:"english",title:"🔤 英文",color:"#34A853"},{id:"science",title:"🔬 常識",color:"#9C27B0"}];return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 我的進度</h2>
        ${e?`<span class="topic-badge" style="background:${a}">${f(e)} ${y(e)}</span>`:""}
      </div>
      ...
      ${e?`<div class="card" style="margin-bottom:12px">
        ...
        ${i.map(s=>{var m;const l=((m=t.subjectProgress)==null?void 0:m[s.id])||{},x=l.total?Math.round(l.completed/l.total*100):0;return`
      ...
      ${["emotions","respect","honesty","conflict"].map(s=>{const l=t.topicProgress[s]||{},x=l.total?Math.round(l.completed/l.total*100):0,m=I(s);return`
          <div class="card" style="margin-bottom:10px">
            ...
            <div style="height:8px;background:var(--border);border-radius:4px;overflow:hidden">
              <div style="height:100%;width:${x}%;background:${(m==null?void 0:m.color)||"var(--primary)"};border-radius:4px;transition:width 0.4s"></div>
            </div>
          </div>
        `}).join("")}
  ...
  `}window.FC.selectStudent=function(e){e!=="其他"&&(M(e),c={...c,student:e,view:"home"},d())};window.FC.addStudent=function(){var n;const e=document.getElementById("new-student-name"),t=(n=e==null?void 0:e.value)==null?void 0:n.trim();t&&(M(t),c={...c,student:t,view:"home"},d())};function ye(){return`
    <div class="container fade-in">
  ...
  `}window.FC.doLogin=function(){var t;if(((t=document.getElementById("teacher-pw"))==null?void 0:t.value)==="admin")c={...c,view:"teacher",teacherMode:!0},d();else{const n=document.getElementById("login-error");n&&(n.style.display="block")}};function Ce(){return`
  ...
  `}function _e(){const e=_();return e.length?`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 老師儀表板</h2>
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${e.map(t=>{var r;const n=t.totalMoralScore||0,o=((r=t.completedScenarios)==null?void 0:r.length)||0,a=TEACHER_EMOJI[t.name]||"👤",i=n>=200?"🌟":n>=100?"⭐":n>=50?"✨":"💫";return`
      ...
      <div class="card" style="margin-top:16px">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px">
          ${[{id:"math",label:"🎯",color:"#4285F4"},{id:"chinese",label:"📐",color:"#EA4335"},{id:"english",label:"🔤",color:"#34A853"},{id:"science",label:"🔬",color:"#9C27B0"}].map(t=>{const n=e.reduce((i,r)=>{var s,l;return i+(((l=(s=r.subjectProgress)==null?void 0:s[t.id])==null?void 0:l.completed)||0)},0),o=e.reduce((i,r)=>{var s,l;return i+(((l=(s=r.subjectProgress)==null?void 0:s[t.id])==null?void 0:l.total)||0)},0),a=o?Math.round(n/o*100):0;return`
              <div style="background:${t.color}18;border:2px solid ${t.color};border-radius:12px;padding:12px;text-align:center">
                ...
                <div style="height:6px;background:#eee;border-radius:3px;margin-top:6px;overflow:hidden">
                  <div style="height:100%;width:${a}%;background:${t.color};border-radius:3px"></div>
                </div>
              </div>`}).join("")}
        </div>
      </div>
  ...
  `:`
    ...
    </div>`}window.FC.handleImport=function(e){var o;const t=(o=e.target.files)==null?void 0:o[0];if(!t)return;const n=new FileReader;n.onload=a=>{const i=V(a.target.result);i.ok?(alert("匯入成功！"),L()):alert("匯入失敗："+i.error)},n.readAsText(t)};window.FC.exportAll=function(){const e=_(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),o=document.createElement("a");o.href=n,o.download="全班進度.json",o.click(),URL.revokeObjectURL(n)};window.FC.speak=function(){const e=A(c.scenarioId);e&&z(e)};window.FC.speakCreeds=function(){var e;(e=c.resultData)!=null&&e.creeds&&Y(c.resultData.creeds)};window.FC.toggleVoice=function(e){const t=!P();Q(t),e.classList.toggle("on",t)};window.FC.setFontSize=function(e){localStorage.setItem("fc_font_size",e),v()};window.FC.setLineHeight=function(e){localStorage.setItem("fc_line_height",e),v()};window.FC.setSpacing=function(e){localStorage.setItem("fc_spacing",e),v()};window.FC.setSpeed=function(e){localStorage.setItem("fc_tts_speed",e),document.getElementById("speed-val").textContent=parseFloat(e).toFixed(2)+"x"};window.FC.resetSettings=function(){Z(),d()};window.FC.exportMyData=function(){const e=T();if(!e)return;const t=U(e),n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),a=document.createElement("a");a.href=o,a.download=`progress_${e}.json`,a.click(),URL.revokeObjectURL(o)};window.FC.importMyData=function(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{var a;const n=(a=t.target.files)==null?void 0:a[0];if(!n)return;const o=new FileReader;o.onload=i=>{const r=V(i.target.result);alert(r.ok?"匯入成功！":"匯入失敗："+r.error),r.ok&&d()},o.readAsText(n)},e.click()};function ke(){document.querySelectorAll(".student-name").forEach((e,t)=>{const n=_();n[t]&&(e.textContent=n[t].name)})}function d(){!T()&&c.view!=="login"&&c.view!=="subject-select"&&(c={...c,view:"subject-select"}),console.log("[FC] render, view:",c.view);let e="";try{switch(c.view){case"student-select":e=we();break;case"subject-select":e=Ce();break;case"login":e=ye();break;case"teacher":e=_e(),ke();break;case"home":e=ae(c.subjectId);break;case"topic":e=ie(c.topicId,c.subjectId);break;case"play":e=ce(c.scenarioId,c.subjectId);break;case"result":e=re(c.resultData,c.subjectId);break;case"progress":e=se(c.subjectId);break;case"settings":e=le();break;default:e='<div class="container"><p>頁面不存在</p></div>'}console.log("[FC] html length:",e.length),b.innerHTML=e}catch(t){console.error("[FC] RENDER ERROR:",t.message,t.stack),b.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+t.message+`
`+(t.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}}te(C);try{d(),console.log("[FC] render complete, app innerHTML length:",b.innerHTML.length)}catch(e){console.error("[FC] RENDER ERROR:",e.message,e.stack),b.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+e.message+`
`+(e.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}

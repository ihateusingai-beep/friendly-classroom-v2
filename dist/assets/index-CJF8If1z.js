(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const $="fc_progress_";function u(e){try{const t=localStorage.getItem($+e);return t?JSON.parse(t):{name:e,completedScenarios:[],topicProgress:{emotions:{completed:0,total:0},respect:{completed:0,total:0},honesty:{completed:0,total:0},conflict:{completed:0,total:0}},subjectProgress:{math:{completed:0,total:0},chinese:{completed:0,total:0},english:{completed:0,total:0},science:{completed:0,total:0}},totalMoralScore:0,lastPlayed:null}}catch{return{name:e,completedScenarios:[],topicProgress:{},subjectProgress:{},totalMoralScore:0,lastPlayed:null}}}function I(e){e.lastPlayed=new Date().toISOString().split("T")[0],localStorage.setItem($+e.name,JSON.stringify(e))}function J(e,t,n,o,i){const a=u(e);return a.completedScenarios.includes(t)||(a.completedScenarios.push(t),a.totalMoralScore=Math.max(0,(a.totalMoralScore||0)+o),a.topicProgress[n]&&a.topicProgress[n].completed++,i&&a.subjectProgress[i]&&a.subjectProgress[i].completed++,I(a)),a}function q(e,t,n){const o=u(e);o.topicProgress[t]?o.topicProgress[t].total=n:o.topicProgress[t]={completed:0,total:n},I(o)}function _(){const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);if(n.startsWith($))try{e.push(JSON.parse(localStorage.getItem(n)))}catch{}}return e}function E(e){try{const t=JSON.parse(e),n=u(t.name);return t.completedScenarios.forEach(o=>{n.completedScenarios.includes(o)||n.completedScenarios.push(o)}),n.totalMoralScore=Math.max(n.totalMoralScore||0,t.totalMoralScore||0),I(n),{ok:!0}}catch(t){return{ok:!1,error:t.message}}}function W(e){const t=u(e);return JSON.stringify(t,null,2)}function G(e,t){return u(e).completedScenarios.includes(t)}const Q=[{id:"emotions",title:"情緒與規範",emoji:"🎭",description:"學習管理情緒、守規矩、尊重他人",creedIds:[1,5,7],color:"#FF6B6B"},{id:"respect",title:"尊重與關懷",emoji:"🤝",description:"學習尊重別人、關心他人、不嘲笑",creedIds:[4,5],color:"#4ECDC4"},{id:"honesty",title:"誠實與責任",emoji:"⚖️",description:"學習誠實面對、勇於承擔責任",creedIds:[2,6],color:"#45B7D1"},{id:"conflict",title:"衝突與求助",emoji:"💪",description:"學習解決衝突、向人求助",creedIds:[2,5,7],color:"#96CEB4"}];function P(e){return Q.find(t=>t.id===e)}const Y=[{id:1,title:"守法的",text:"我們是守法的：遵守校規，奉公守法"},{id:2,title:"信實的",text:"我們是信實的：誠實負責，不欺騙人"},{id:3,title:"整潔的",text:"我們是整潔的：校服整潔，儀容端正"},{id:4,title:"友愛的",text:"我們是友愛的：關心別人，互相幫助"},{id:5,title:"禮讓的",text:"我們是禮讓的：待人有禮，不易發怒"},{id:6,title:"勤力的",text:"我們是勤力的：上課專心，努力學習"},{id:7,title:"合作的",text:"我們是合作的：遵守規則，積極參與"},{id:8,title:"獨立的",text:"我們是獨立的：自己的事，自己去做"},{id:9,title:"愛護學校的",text:"我們是愛護學校的：愛護公物，保護環境"},{id:10,title:"感恩的",text:"我們是感恩的：尊敬師長，孝順父母"}];function V(e){return Y.filter(t=>e.includes(t.id))}function Z(e){return V(e).map(t=>`${t.title}：${t.text}`)}const z="audio/";let w=!0,g=!1,p=null;function X(){return{speed:parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),fontSize:parseInt(localStorage.getItem("fc_font_size")||"18"),lineHeight:parseFloat(localStorage.getItem("fc_line_height")||"1.5"),spacing:localStorage.getItem("fc_spacing")||"medium"}}function f(){const e=X(),t={narrow:"8px",medium:"16px",wide:"28px"},n=document.documentElement;n.style.setProperty("--fc-font-size",e.fontSize+"px"),n.style.setProperty("--fc-line-height",e.lineHeight),n.style.setProperty("--fc-spacing",t[e.spacing]||"16px")}function T(e){w=e}function k(){return w}function A(){g=!1,p&&(p.pause(),p=null)}function M(e){A();const t=z+e;console.log("[FC Audio] Playing:",t),p=new Audio(t),p.onended=()=>{g=!1,p=null,console.log("[FC Audio] Done")},p.onerror=n=>{console.error("[FC Audio] Error:",n),g=!1,p=null},p.play().catch(n=>{console.error("[FC Audio] Play failed:",n.message),g=!1,p=null}),g=!0}function B(e){if(console.log("[FC Audio] speakScenario called, enabled:",w,"speaking:",g,"scenario:",e),!w){console.log("[FC Audio] Blocked: voice not enabled");return}if(g){console.log("[FC Audio] Blocked: already speaking");return}const t=(e==null?void 0:e.id)||e;console.log("[FC Audio] Playing scenario:",t),M(`scenarios/${t}.mp3`)}function R(e){if(!w||g||!e||e.length===0)return;const t=e[0].id||e[0];M(`creeds/creed-${t}.mp3`)}function ee(e){var i,a,s;if(!e)return;g&&((i=window.speechSynthesis)==null||i.cancel());const t=new SpeechSynthesisUtterance(e);t.lang="zh-HK",t.rate=X().speed||.85,t.pitch=1;const n=((a=window.speechSynthesis)==null?void 0:a.getVoices())||[],o=n.find(r=>r.lang==="zh-HK")||n.find(r=>r.lang==="zh-TW")||n.find(r=>r.lang==="zh-CN")||n.find(r=>r.lang.includes("zh"))||n[0];o&&(t.voice=o,console.log("[FC TTS] Voice:",o.name)),t.onstart=()=>{g=!0,console.log("[FC TTS] Speaking:",e.slice(0,30))},t.onend=()=>{g=!1,console.log("[FC TTS] Done")},t.onerror=r=>{g=!1,console.error("[FC TTS] Error:",r.error),r.error==="not-allowed"&&console.log("[FC TTS] Fallback to MP3...")},(s=window.speechSynthesis)==null||s.speak(t)}function te(){localStorage.removeItem("fc_tts_speed"),localStorage.removeItem("fc_font_size"),localStorage.removeItem("fc_line_height"),localStorage.removeItem("fc_spacing"),f()}function ne(e){e.forEach(t=>{const n=new Audio(z+"scenarios/"+t+".mp3");n.preload="auto"})}f();window._fcAudio={speakScenario:B,speakCreeds:R,speak:ee,setEnabled:T,isEnabled:k,preloadAudio:ne,applyCSS:f};window.addEventListener("beforeunload",()=>{A()});const F=[{id:"math",title:"數學",emoji:"🎯",color:"#4285F4",bgColor:"#E8F0FE"},{id:"chinese",title:"中文",emoji:"📐",color:"#EA4335",bgColor:"#FCE8E6"},{id:"english",title:"英文",emoji:"🔤",color:"#34A853",bgColor:"#E6F4EA"},{id:"science",title:"常識",emoji:"🔬",color:"#9C27B0",bgColor:"#F3E5F5"}];function y(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.color)||"#666"}function oe(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.bgColor)||"#f5f5f5"}function C(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.title)||""}function b(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.emoji)||""}let h=null,x=null,S=[];function L(e){h=e}function ae(){return h}function ie(e){S=e}function ce(){return S}function O(e){return S.filter(t=>t.topicId===e)}function H(e){return x=S.find(t=>t.id===e)||null,x}function re(e,t){const n=x;if(!n)return null;const o=n.options.find(r=>r.id===e);if(!o)return null;let i=0,a="";o.effects.forEach(r=>{i+=r.moralChange||0,r.comment&&(a=r.comment)}),h&&J(h,n.id,n.topicId,i,t);const s=V(n.creedIds||[]);return{option:o,moralChange:i,mainComment:a,creeds:s,creedText:Z(n.creedIds||[])}}function D(e){if(!h)return;const t=O(e);q(h,e,t.length)}function se(e){const t=y(e),n=oe(e),o=k()?'<button class="btn btn-outline" style="margin-bottom:12px;font-size:0.9em" onclick="FC.testTTS()">🔊 測試發音</button>':"";return`
    <div class="container fade-in">
      ...
      <div class="topic-grid">
        ${[{id:"emotions",emoji:"🎭",title:"情緒與規範",sub:"管理情緒、守規矩",color:"#FF6B6B"},{id:"respect",emoji:"🤝",title:"尊重與關懷",sub:"尊重別人、關心他人",color:"#4ECDC4"},{id:"honesty",emoji:"⚖️",title:"誠實與責任",sub:"誠實面對、勇於承擔",color:"#45B7D1"},{id:"conflict",emoji:"💪",title:"衝突與求助",sub:"解決衝突、向人求助",color:"#96CEB4"}].map(i=>{const a=h?u(h).topicProgress[i.id]||{}:{},s=a.total?Math.round(a.completed/a.total*100):0;return`
  ...
  `}function le(e,t){const n=P(e),o=O(e),i=y(t);return D(e),`
    <div class="container fade-in">
      <div class="page-header">
      ...
      <ul class="scenario-list">
        ${o.map(a=>{const s=h&&G(h,a.id);return`
  ...
  `}function de(e,t){const n=H(e);if(!n)return'<div class="container"><p>場景不存在</p></div>';const o=P(n.topicId),i=y(t);return`
    <div class="container fade-in">
      <div class="page-header">
  ...
  `}function me(e,t){const{option:n,moralChange:o,mainComment:i,creeds:a,creedText:s}=e,r=o>=0,l=y(t);return`
    <div class="container fade-in">
  ...
  `}function ge(e){var s;const t=u(h),n=t.totalMoralScore||0,o=((s=t.completedScenarios)==null?void 0:s.length)||0,i=y(e),a=[{id:"math",title:"🎯 數學",color:"#4285F4"},{id:"chinese",title:"📐 中文",color:"#EA4335"},{id:"english",title:"🔤 英文",color:"#34A853"},{id:"science",title:"🔬 常識",color:"#9C27B0"}];return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 我的進度</h2>
      ...
      ${e?`<div class="card" style="margin-bottom:12px">
        ...
        ${a.map(r=>{var m;const l=((m=t.subjectProgress)==null?void 0:m[r.id])||{},v=l.total?Math.round(l.completed/l.total*100):0;return`
      ...
      ${["emotions","respect","honesty","conflict"].map(r=>{const l=t.topicProgress[r]||{},v=l.total?Math.round(l.completed/l.total*100):0,m=P(r);return`
          <div class="card" style="margin-bottom:10px">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">
              <span style="font-size:1.2em">${(m==null?void 0:m.emoji)||""}</span>
              <strong>${(m==null?void 0:m.title)||r}</strong>
              <span style="margin-left:auto;color:var(--text-light)">${l.completed||0}/${l.total||0}</span>
            </div>
            <div style="height:8px;background:var(--border);border-radius:4px;overflow:hidden">
              <div style="height:100%;width:${v}%;background:${(m==null?void 0:m.color)||"var(--primary)"};border-radius:4px;transition:width 0.4s"></div>
            </div>
          </div>
        `}).join("")}
  ...
  `}function he(){const e=localStorage.getItem("fc_tts_speed")||"0.85",t=localStorage.getItem("fc_font_size")||"18",n=localStorage.getItem("fc_line_height")||"1.5",o=localStorage.getItem("fc_spacing")||"medium",i=t<=18?"小":t<=22?"中":"大";return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>⚙️ 個人化設定</h2>
  ...
  `}window.FC.selectStudent=function(e){e!=="其他"&&(L(e),c={...c,student:e,view:"home"},d())};window.FC.addStudent=function(){var n;const e=document.getElementById("new-student-name"),t=(n=e==null?void 0:e.value)==null?void 0:n.trim();t&&(L(t),c={...c,student:t,view:"home"},d())};function Se(){return`
    <div class="container fade-in">
  ...
  `}window.FC.doLogin=function(){var t;if(((t=document.getElementById("teacher-pw"))==null?void 0:t.value)==="admin")c={...c,view:"teacher",teacherMode:!0},d();else{const n=document.getElementById("login-error");n&&(n.style.display="block")}};function je(){return`
  ...
  `}function $e(){const e=_();return e.length?`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 老師儀表板</h2>
  ...
  `:`
    <div class="container fade-in">
      ...
      <div class="footer" style="text-align:center;padding:16px;font-size:14px;color:var(--text-light);border-top:1px solid var(--border);margin-top:auto">© Ken Cheng 製作</div>
    </div>`}window.FC.handleImport=function(e){var o;const t=(o=e.target.files)==null?void 0:o[0];if(!t)return;const n=new FileReader;n.onload=i=>{const a=E(i.target.result);a.ok?(alert("匯入成功！"),U()):alert("匯入失敗："+a.error)},n.readAsText(t)};window.FC.exportAll=function(){const e=_(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),o=document.createElement("a");o.href=n,o.download="全班進度.json",o.click(),URL.revokeObjectURL(n)};window.FC.speak=function(){const e=H(c.scenarioId);e&&B(e)};window.FC.speakOpt=function(e){const t=H(c.scenarioId);if(!t)return;const n=t.options.find(o=>o.id===e);if(n){const{speak:o}=window._fcAudio||{};o&&o(n.text)}};window.FC.speakCreeds=function(){var e;(e=c.resultData)!=null&&e.creeds&&R(c.resultData.creeds)};window.FC.toggleVoice=function(e){const t=!k();T(t),e&&e.classList.toggle("on",t),t&&!localStorage.getItem("fc_voice_seen")&&localStorage.setItem("fc_voice_seen","1")};window.FC.setFontSize=function(e){localStorage.setItem("fc_font_size",e),f();const t=document.querySelector('[data-for="fs"]');t&&(t.textContent=e<=18?"小":e<=22?"中":"大")};window.FC.setLineHeight=function(e){localStorage.setItem("fc_line_height",e),f();const t=document.querySelector('[data-for="lh"]');t&&(t.textContent=parseFloat(e).toFixed(1))};window.FC.setSpacing=function(e){localStorage.setItem("fc_spacing",e),f(),["narrow","medium","wide"].forEach(t=>{const n=document.getElementById("sp-"+t);n&&(n.className="btn "+(t===e?"btn-primary":"btn-outline"))})};window.FC.setSpeed=function(e){localStorage.setItem("fc_tts_speed",e);const t=document.querySelector('[data-for="speed"]');t&&(t.textContent=parseFloat(e).toFixed(2)+"x")};window.FC.resetSettings=function(){te(),d()};window.FC.exportMyData=function(){const e=ae();if(!e)return;const t=W(e),n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download=`progress_${e}.json`,i.click(),URL.revokeObjectURL(o)};window.FC.importMyData=function(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{var i;const n=(i=t.target.files)==null?void 0:i[0];if(!n)return;const o=new FileReader;o.onload=a=>{const s=E(a.target.result);alert(s.ok?"匯入成功！":"匯入失敗："+s.error),s.ok&&d()},o.readAsText(n)},e.click()};function Ie(){document.querySelectorAll(".student-name").forEach((e,t)=>{const n=_();n[t]&&(e.textContent=n[t].name)})}function d(){let e="";try{switch(c.view){case"student-select":e=Fe();break;case"subject-select":e=je();break;case"login":e=Se();break;case"teacher":e=$e(),Ie();break;case"home":e=se(c.subjectId);break;case"topic":e=le(c.topicId,c.subjectId);break;case"play":e=de(c.scenarioId,c.subjectId);break;case"result":e=me(c.resultData,c.subjectId);break;case"progress":e=ge(c.subjectId);break;case"settings":e=he();break;default:e='<div class="container"><p>頁面不存在</p></div>'}j.innerHTML=e}catch(t){console.error("RENDER ERROR:",t.message,t.stack),j.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+t.message+`
`+(t.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}}ie(pe);try{d()}catch(e){console.error("RENDER ERROR:",e.message,e.stack),j.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+e.message+`
`+(e.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}

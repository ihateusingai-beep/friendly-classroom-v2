(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();const j="fc_progress_";function p(e){try{const t=localStorage.getItem(j+e);return t?JSON.parse(t):{name:e,completedScenarios:[],topicProgress:{emotions:{completed:0,total:0},respect:{completed:0,total:0},honesty:{completed:0,total:0},conflict:{completed:0,total:0}},subjectProgress:{math:{completed:0,total:0},chinese:{completed:0,total:0},english:{completed:0,total:0},science:{completed:0,total:0}},totalMoralScore:0,lastPlayed:null}}catch{return{name:e,completedScenarios:[],topicProgress:{},subjectProgress:{},totalMoralScore:0,lastPlayed:null}}}function $(e){e.lastPlayed=new Date().toISOString().split("T")[0],localStorage.setItem(j+e.name,JSON.stringify(e))}function L(e,t,n,o,a){const i=p(e);return i.completedScenarios.includes(t)||(i.completedScenarios.push(t),i.totalMoralScore=Math.max(0,(i.totalMoralScore||0)+o),i.topicProgress[n]&&i.topicProgress[n].completed++,a&&i.subjectProgress[a]&&i.subjectProgress[a].completed++,$(i)),i}function O(e,t,n){const o=p(e);o.topicProgress[t]?o.topicProgress[t].total=n:o.topicProgress[t]={completed:0,total:n},$(o)}function _(){const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);if(n.startsWith(j))try{e.push(JSON.parse(localStorage.getItem(n)))}catch{}}return e}function V(e){try{const t=JSON.parse(e),n=p(t.name);return t.completedScenarios.forEach(o=>{n.completedScenarios.includes(o)||n.completedScenarios.push(o)}),n.totalMoralScore=Math.max(n.totalMoralScore||0,t.totalMoralScore||0),$(n),{ok:!0}}catch(t){return{ok:!1,error:t.message}}}function D(e){const t=p(e);return JSON.stringify(t,null,2)}function U(e,t){return p(e).completedScenarios.includes(t)}const J=[{id:"emotions",title:"情緒與規範",emoji:"🎭",description:"學習管理情緒、守規矩、尊重他人",creedIds:[1,5,7],color:"#FF6B6B"},{id:"respect",title:"尊重與關懷",emoji:"🤝",description:"學習尊重別人、關心他人、不嘲笑",creedIds:[4,5],color:"#4ECDC4"},{id:"honesty",title:"誠實與責任",emoji:"⚖️",description:"學習誠實面對、勇於承擔責任",creedIds:[2,6],color:"#45B7D1"},{id:"conflict",title:"衝突與求助",emoji:"💪",description:"學習解決衝突、向人求助",creedIds:[2,5,7],color:"#96CEB4"}];function I(e){return J.find(t=>t.id===e)}const W=[{id:1,title:"守法的",text:"我們是守法的：遵守校規，奉公守法"},{id:2,title:"信實的",text:"我們是信實的：誠實負責，不欺騙人"},{id:3,title:"整潔的",text:"我們是整潔的：校服整潔，儀容端正"},{id:4,title:"友愛的",text:"我們是友愛的：關心別人，互相幫助"},{id:5,title:"禮讓的",text:"我們是禮讓的：待人有禮，不易發怒"},{id:6,title:"勤力的",text:"我們是勤力的：上課專心，努力學習"},{id:7,title:"合作的",text:"我們是合作的：遵守規則，積極參與"},{id:8,title:"獨立的",text:"我們是獨立的：自己的事，自己去做"},{id:9,title:"愛護學校的",text:"我們是愛護學校的：愛護公物，保護環境"},{id:10,title:"感恩的",text:"我們是感恩的：尊敬師長，孝順父母"}];function K(e){return W.filter(t=>e.includes(t.id))}function G(e){return K(e).map(t=>`${t.title}：${t.text}`)}let k=!1,g=!1;function q(e){k=e}function P(){return k}function H(){return{speed:parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),fontSize:parseInt(localStorage.getItem("fc_font_size")||"18"),lineHeight:parseFloat(localStorage.getItem("fc_line_height")||"1.5"),spacing:localStorage.getItem("fc_spacing")||"medium"}}function v(){const e=H(),t={narrow:"8px",medium:"16px",wide:"28px"},n=document.documentElement;n.style.setProperty("--fc-font-size",e.fontSize+"px"),n.style.setProperty("--fc-line-height",e.lineHeight),n.style.setProperty("--fc-spacing",t[e.spacing]||"16px")}function X(){if(typeof speechSynthesis>"u")return null;const e=speechSynthesis.getVoices();let t=e.find(n=>n.lang.startsWith("zh-HK")||n.lang.startsWith("zh-yue"));return t||(t=e.find(n=>n.lang.startsWith("zh"))),t||(t=e.find(n=>n.lang.startsWith("en"))),t||null}function z(e){if(!k||g)return;speechSynthesis.cancel(),g=!0;const t=H(),n=["A","B","C","D"],o=e.options.map((r,s)=>`${n[s]}。${r.text}`).join("。"),a=`${e.title}。${e.description}。選項：${o}`,i=new SpeechSynthesisUtterance(a);i.voice=X(),i.rate=t.speed,i.onend=()=>{g=!1},i.onerror=()=>{g=!1},speechSynthesis.speak(i)}function Q(e){if(!k||g)return;speechSynthesis.cancel(),g=!0;const t=H(),n=e.map(a=>`${a.title}：${a.text}`).join("。"),o=new SpeechSynthesisUtterance(n);o.voice=X(),o.rate=t.speed,o.onend=()=>{g=!1},o.onerror=()=>{g=!1},speechSynthesis.speak(o)}function Y(){localStorage.removeItem("fc_tts_speed"),localStorage.removeItem("fc_font_size"),localStorage.removeItem("fc_line_height"),localStorage.removeItem("fc_spacing"),v()}typeof speechSynthesis<"u"&&(speechSynthesis.onvoiceschanged=()=>speechSynthesis.getVoices());window.addEventListener("beforeunload",()=>{g=!1});const F=[{id:"math",title:"數學",emoji:"🎯",color:"#4285F4",bgColor:"#E8F0FE"},{id:"chinese",title:"中文",emoji:"📐",color:"#EA4335",bgColor:"#FCE8E6"},{id:"english",title:"英文",emoji:"🔤",color:"#34A853",bgColor:"#E6F4EA"},{id:"science",title:"常識",emoji:"🔬",color:"#9C27B0",bgColor:"#F3E5F5"}];function w(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.color)||"#666"}function Z(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.bgColor)||"#f5f5f5"}function y(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.title)||""}function f(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.emoji)||""}let h=null,u=null,S=[];function M(e){h=e}function ee(){return h}function te(e){S=e}function ne(){return S}function T(e){return S.filter(t=>t.topicId===e)}function R(e){return u=S.find(t=>t.id===e)||null,u}function oe(e,t){const n=u;if(!n)return null;const o=n.options.find(s=>s.id===e);if(!o)return null;let a=0,i="";o.effects.forEach(s=>{a+=s.moralChange||0,s.comment&&(i=s.comment)}),h&&L(h,n.id,n.topicId,a,t);const r=K(n.creedIds||[]);return{option:o,moralChange:a,mainComment:i,creeds:r,creedText:G(n.creedIds||[])}}function A(e){if(!h)return;const t=T(e);O(h,e,t.length)}function ae(e){const t=w(e),n=Z(e);return`
  ...
  `}function ie(e,t){const n=I(e),o=T(e),a=w(t);return A(e),`
    <div class="container fade-in">
      <div class="page-header">
      ...
      <ul class="scenario-list">
        ${o.map(i=>{const r=h&&U(h,i.id);return`
  ...
  `}function ce(e,t){const n=R(e);if(!n)return'<div class="container"><p>場景不存在</p></div>';const o=I(n.topicId),a=w(t);return`
    <div class="container fade-in">
      <div class="page-header">

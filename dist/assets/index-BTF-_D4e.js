(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const P="fc_progress_";function p(e){try{const t=localStorage.getItem(P+e);return t?JSON.parse(t):{name:e,completedScenarios:[],topicProgress:{emotions:{completed:0,total:0},respect:{completed:0,total:0},honesty:{completed:0,total:0},conflict:{completed:0,total:0}},subjectProgress:{math:{completed:0,total:0},chinese:{completed:0,total:0},english:{completed:0,total:0},science:{completed:0,total:0}},totalMoralScore:0,lastPlayed:null}}catch{return{name:e,completedScenarios:[],topicProgress:{},subjectProgress:{},totalMoralScore:0,lastPlayed:null}}}function H(e){e.lastPlayed=new Date().toISOString().split("T")[0],localStorage.setItem(P+e.name,JSON.stringify(e))}function q(e,t,n,o,i){const a=p(e);return a.completedScenarios.includes(t)||(a.completedScenarios.push(t),a.totalMoralScore=Math.max(0,(a.totalMoralScore||0)+o),a.topicProgress[n]&&a.topicProgress[n].completed++,i&&a.subjectProgress[i]&&a.subjectProgress[i].completed++,H(a)),a}function G(e,t,n){const o=p(e);o.topicProgress[t]?o.topicProgress[t].total=n:o.topicProgress[t]={completed:0,total:n},H(o)}function _(){const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);if(n.startsWith(P))try{e.push(JSON.parse(localStorage.getItem(n)))}catch{}}return e}function A(e){try{const t=JSON.parse(e),n=p(t.name);return t.completedScenarios.forEach(o=>{n.completedScenarios.includes(o)||n.completedScenarios.push(o)}),n.totalMoralScore=Math.max(n.totalMoralScore||0,t.totalMoralScore||0),H(n),{ok:!0}}catch(t){return{ok:!1,error:t.message}}}function Y(e){const t=p(e);return JSON.stringify(t,null,2)}function Q(e,t){return p(e).completedScenarios.includes(t)}const Z=[{id:"emotions",title:"情緒與規範",emoji:"🎭",description:"學習管理情緒、守規矩、尊重他人",creedIds:[1,5,7],color:"#FF6B6B"},{id:"respect",title:"尊重與關懷",emoji:"🤝",description:"學習尊重別人、關心他人、不嘲笑",creedIds:[4,5],color:"#4ECDC4"},{id:"honesty",title:"誠實與責任",emoji:"⚖️",description:"學習誠實面對、勇於承擔責任",creedIds:[2,6],color:"#45B7D1"},{id:"conflict",title:"衝突與求助",emoji:"💪",description:"學習解決衝突、向人求助",creedIds:[2,5,7],color:"#96CEB4"}];function K(e){return Z.find(t=>t.id===e)}const ee=[{id:1,title:"守法的",text:"我們是守法的：遵守校規，奉公守法"},{id:2,title:"信實的",text:"我們是信實的：誠實負責，不欺騙人"},{id:3,title:"整潔的",text:"我們是整潔的：校服整潔，儀容端正"},{id:4,title:"友愛的",text:"我們是友愛的：關心別人，互相幫助"},{id:5,title:"禮讓的",text:"我們是禮讓的：待人有禮，不易發怒"},{id:6,title:"勤力的",text:"我們是勤力的：上課專心，努力學習"},{id:7,title:"合作的",text:"我們是合作的：遵守規則，積極參與"},{id:8,title:"獨立的",text:"我們是獨立的：自己的事，自己去做"},{id:9,title:"愛護學校的",text:"我們是愛護學校的：愛護公物，保護環境"},{id:10,title:"感恩的",text:"我們是感恩的：尊敬師長，孝順父母"}];function T(e){return ee.filter(t=>e.includes(t.id))}function te(e){return T(e).map(t=>`${t.title}：${t.text}`)}let b=!1,m=!1,C={};function M(e){b=e}function k(){return b}function R(){return{speed:parseFloat(localStorage.getItem("fc_tts_speed")||"0.85"),fontSize:parseInt(localStorage.getItem("fc_font_size")||"18"),lineHeight:parseFloat(localStorage.getItem("fc_line_height")||"1.5"),spacing:localStorage.getItem("fc_spacing")||"medium"}}function v(){const e=R(),t={narrow:"8px",medium:"16px",wide:"28px"},n=document.documentElement;n.style.setProperty("--fc-font-size",e.fontSize+"px"),n.style.setProperty("--fc-line-height",e.lineHeight),n.style.setProperty("--fc-spacing",t[e.spacing]||"16px")}function ne(){if(typeof speechSynthesis>"u")return null;const e=speechSynthesis.getVoices();let t=e.find(n=>n.lang.startsWith("zh-HK")||n.lang.startsWith("zh-yue"));return t||(t=e.find(n=>n.lang.startsWith("zh"))),t||(t=e.find(n=>n.lang.startsWith("en"))),t||null}function oe(){return typeof speechSynthesis>"u"?!1:speechSynthesis.getVoices().some(t=>t.lang.startsWith("zh"))}function ae(e,t){if(typeof speechSynthesis>"u")return!1;speechSynthesis.cancel(),m=!0;const n=new SpeechSynthesisUtterance(e);return n.voice=ne(),n.rate=t,n.pitch=1,n.onend=()=>{m=!1},n.onerror=()=>{m=!1,e&&B(e)},speechSynthesis.speak(n),!0}const j=localStorage.getItem("fc_tts_proxy")||"",$=localStorage.getItem("fc_mmx_key")||"";function B(e){if(!j||!$){m=!1;return}const t=e.slice(0,80);if(C[t]){X(C[t]);return}fetch(j,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+$},body:JSON.stringify({text:e,model:"speech-01-turbo",voice:"Cantonese_GentleLady"})}).then(n=>n.json()).then(n=>{var o;(o=n.data)!=null&&o.audio_url?(C[t]=n.data.audio_url,X(n.data.audio_url)):m=!1}).catch(()=>{m=!1})}function X(e){const t=new Audio(e);window._fcAudio=window._fcAudio||{},window._fcAudio._currentAudio=t,t.onended=()=>{m=!1},t.onerror=()=>{m=!1},t.play().catch(()=>{m=!1})}function N(e){!b||m||!e||(oe()?ae(e,R().speed):j&&$?B(e):m=!1)}function O(e){if(!b||m)return;const t=["A","B","C","D"],n=e.options.map((i,a)=>`${t[a]}。${i.text}`).join("。"),o=`${e.title}。${e.description}。選項：${n}`;N(o)}function L(e){if(!b||m)return;const t=e.map(n=>`${n.title}：${n.text}`).join("。");N(t)}function ie(){localStorage.removeItem("fc_tts_speed"),localStorage.removeItem("fc_font_size"),localStorage.removeItem("fc_line_height"),localStorage.removeItem("fc_spacing"),C={},v()}typeof speechSynthesis<"u"&&(speechSynthesis.getVoices(),speechSynthesis.onvoiceschanged=()=>speechSynthesis.getVoices(),setTimeout(()=>speechSynthesis.getVoices(),100),setTimeout(()=>speechSynthesis.getVoices(),500));window._fcAudio={speak:N,speakScenario:O,speakCreeds:L,setEnabled:M,isEnabled:k};window.addEventListener("beforeunload",()=>{m=!1});const F=[{id:"math",title:"數學",emoji:"🎯",color:"#4285F4",bgColor:"#E8F0FE"},{id:"chinese",title:"中文",emoji:"📐",color:"#EA4335",bgColor:"#FCE8E6"},{id:"english",title:"英文",emoji:"🔤",color:"#34A853",bgColor:"#E6F4EA"},{id:"science",title:"常識",emoji:"🔬",color:"#9C27B0",bgColor:"#F3E5F5"}];function w(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.color)||"#666"}function ce(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.bgColor)||"#f5f5f5"}function y(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.title)||""}function f(e){var t;return((t=F.find(n=>n.id===e))==null?void 0:t.emoji)||""}let g=null,u=null,S=[];function D(e){g=e}function re(){return g}function se(e){S=e}function le(){return S}function U(e){return S.filter(t=>t.topicId===e)}function V(e){return u=S.find(t=>t.id===e)||null,u}function de(e,t){const n=u;if(!n)return null;const o=n.options.find(s=>s.id===e);if(!o)return null;let i=0,a="";o.effects.forEach(s=>{i+=s.moralChange||0,s.comment&&(a=s.comment)}),g&&q(g,n.id,n.topicId,i,t);const r=T(n.creedIds||[]);return{option:o,moralChange:i,mainComment:a,creeds:r,creedText:te(n.creedIds||[])}}function J(e){if(!g)return;const t=U(e);G(g,e,t.length)}function me(e){const t=w(e),n=ce(e),o=k()?'<button class="btn btn-outline" style="margin-bottom:12px;font-size:0.9em" onclick="FC.testTTS()">🔊 測試發音</button>':"";return`
    <div class="container fade-in">
      ...
      <div class="subject-banner" style="background:${n};border:2px solid ${t}">
        <span style="font-size:1.5em">${f(e)}</span>
        <div>
          <div style="font-weight:600;color:${t}">${y(e)}學模擬練習</div>
      ...
      <div class="topic-grid">
        ${[{id:"emotions",emoji:"🎭",title:"情緒與規範",sub:"管理情緒、守規矩",color:"#FF6B6B"},{id:"respect",emoji:"🤝",title:"尊重與關懷",sub:"尊重別人、關心他人",color:"#4ECDC4"},{id:"honesty",emoji:"⚖️",title:"誠實與責任",sub:"誠實面對、勇於承擔",color:"#45B7D1"},{id:"conflict",emoji:"💪",title:"衝突與求助",sub:"解決衝突、向人求助",color:"#96CEB4"}].map(i=>{const a=g?p(g).topicProgress[i.id]||{}:{},r=a.total?Math.round(a.completed/a.total*100):0;return`
  ...
  `}function he(e,t){const n=K(e),o=U(e),i=w(t);return J(e),`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>${n.emoji} ${n.title}</h2>
        ${t?`<span class="topic-badge" style="background:${i}">${f(t)} ${y(t)}</span>`:""}
      </div>
      <p style="color:var(--text-light);margin-bottom:16px">${n.description}</p>

      <ul class="scenario-list">
        ${o.map(a=>{const r=g&&Q(g,a.id);return`
            <li class="scenario-item ${r?"completed":""}" onclick="FC.play('${a.id}')">
              <div class="check">${r?"✓":""}</div>
              <div class="info">
  ...
  `}function ge(e,t){const n=V(e);if(!n)return'<div class="container"><p>場景不存在</p></div>';const o=K(n.topicId),i=w(t);return`
    <div class="container fade-in">
      <div class="page-header">
      ...
      <div class="options">
        ${n.options.map((a,r)=>{const s=["A","B","C","D"];return`
            <div class="option-card" onclick="FC.choose('${a.id}')">
              <span class="opt-badge">${s[r]||r+1}</span>
  ...
  `}function pe(e,t){const{option:n,moralChange:o,mainComment:i,creeds:a,creedText:r}=e,s=o>=0,l=w(t);return`
    <div class="container fade-in">
      ${t?`<div style="text-align:center;margin-bottom:8px">
        <span class="topic-badge" style="background:${l}">${f(t)} ${y(t)}</span>
      </div>`:""}
      <div class="result-card ${s?"good":"bad"}">
        <div class="result-emoji">${s?"🌟":"💪"}</div>
        <div class="comment">${i||"你做出了選擇！"}</div>
        <div class="moral-score">${s?"＋":""}${o} 道德分</div>
      </div>
      ...
      <div class="creed-show">
        ...
        <div class="items">
          ${(r||[]).map(x=>`<div class="item">${x}</div>`).join("")}
        </div>
      </div>

      <div class="action-row">
        <button class="btn btn-primary" onclick="FC.retry()">🔄 再做一次</button>
        <button class="btn btn-outline" onclick="FC.goTopic('${u==null?void 0:u.topicId}')">← 返回主題</button>
      </div>

      <button class="voice-fab" onclick="FC.speakCreeds()" title="朗讀信條">🔊</button>
      <div class="footer" style="text-align:center;padding:16px;font-size:14px;color:var(--text-light);border-top:1px solid var(--border);margin-top:auto">© Ken Cheng 製作</div>
    </div>
  `}function ue(e){var r;const t=p(g),n=t.totalMoralScore||0,o=((r=t.completedScenarios)==null?void 0:r.length)||0,i=w(e),a=[{id:"math",title:"🎯 數學",color:"#4285F4"},{id:"chinese",title:"📐 中文",color:"#EA4335"},{id:"english",title:"🔤 英文",color:"#34A853"},{id:"science",title:"🔬 常識",color:"#9C27B0"}];return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 我的進度</h2>
        ${e?`<span class="topic-badge" style="background:${i}">${f(e)} ${y(e)}</span>`:""}
      </div>
      ...
      ${e?`<div class="card" style="margin-bottom:12px">
        ...
        ${a.map(s=>{var h;const l=((h=t.subjectProgress)==null?void 0:h[s.id])||{},x=l.total?Math.round(l.completed/l.total*100):0;return`
            <div style="margin-bottom:8px">
              ...
              <div style="height:8px;background:var(--border);border-radius:4px;overflow:hidden">
                <div style="height:100%;width:${x}%;background:${s.color};border-radius:4px;transition:width 0.4s"></div>
              </div>
            </div>`}).join("")}
      </div>`:""}

      ${["emotions","respect","honesty","conflict"].map(s=>{const l=t.topicProgress[s]||{},x=l.total?Math.round(l.completed/l.total*100):0,h=K(s);return`
          <div class="card" style="margin-bottom:10px">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">
              <span style="font-size:1.2em">${(h==null?void 0:h.emoji)||""}</span>
              <strong>${(h==null?void 0:h.title)||s}</strong>
              <span style="margin-left:auto;color:var(--text-light)">${l.completed||0}/${l.total||0}</span>
            </div>
            <div style="height:8px;background:var(--border);border-radius:4px;overflow:hidden">
              <div style="height:100%;width:${x}%;background:${(h==null?void 0:h.color)||"var(--primary)"};border-radius:4px;transition:width 0.4s"></div>
            </div>
          </div>
        `}).join("")}
  ...
  `}function fe(){const e=localStorage.getItem("fc_tts_speed")||"0.85",t=localStorage.getItem("fc_font_size")||"18",n=localStorage.getItem("fc_line_height")||"1.5",o=localStorage.getItem("fc_spacing")||"medium",i=t<=18?"小":t<=22?"中":"大";return`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>⚙️ 個人化設定</h2>
      ...
      <div class="card" style="margin-bottom:14px">
        ...
        <div class="setting-row" style="margin-bottom:12px">
          ...
          <div class="toggle ${k()?"on":""}" data-key="voice" onclick="FC.toggleVoice(this)"></div>
        </div>
  ...
  `}window.FC.selectStudent=function(e){e!=="其他"&&(D(e),c={...c,student:e,view:"home"},d())};window.FC.addStudent=function(){var n;const e=document.getElementById("new-student-name"),t=(n=e==null?void 0:e.value)==null?void 0:n.trim();t&&(D(t),c={...c,student:t,view:"home"},d())};function Ie(){return`
    <div class="container fade-in">
  ...
  `}window.FC.doLogin=function(){var t;if(((t=document.getElementById("teacher-pw"))==null?void 0:t.value)==="admin")c={...c,view:"teacher",teacherMode:!0},d();else{const n=document.getElementById("login-error");n&&(n.style.display="block")}};function Pe(){return`
  ...
  `}function He(){const e=_();return e.length?`
    <div class="container fade-in">
      <div class="page-header">
        <button class="back-btn" onclick="FC.goHome()">←</button>
        <h2>📊 老師儀表板</h2>
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${e.map(t=>{var r;const n=t.totalMoralScore||0,o=((r=t.completedScenarios)==null?void 0:r.length)||0,i=TEACHER_EMOJI[t.name]||"👤",a=n>=200?"🌟":n>=100?"⭐":n>=50?"✨":"💫";return`
      ...
      <div class="card" style="margin-top:16px">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px">
          ${[{id:"math",label:"🎯",color:"#4285F4"},{id:"chinese",label:"📐",color:"#EA4335"},{id:"english",label:"🔤",color:"#34A853"},{id:"science",label:"🔬",color:"#9C27B0"}].map(t=>{const n=e.reduce((a,r)=>{var s,l;return a+(((l=(s=r.subjectProgress)==null?void 0:s[t.id])==null?void 0:l.completed)||0)},0),o=e.reduce((a,r)=>{var s,l;return a+(((l=(s=r.subjectProgress)==null?void 0:s[t.id])==null?void 0:l.total)||0)},0),i=o?Math.round(n/o*100):0;return`
  ...
  `:`
    <div class="container fade-in">
      ...
      <div class="footer" style="text-align:center;padding:16px;font-size:14px;color:var(--text-light);border-top:1px solid var(--border);margin-top:auto">© Ken Cheng 製作</div>
    </div>`}window.FC.handleImport=function(e){var o;const t=(o=e.target.files)==null?void 0:o[0];if(!t)return;const n=new FileReader;n.onload=i=>{const a=A(i.target.result);a.ok?(alert("匯入成功！"),W()):alert("匯入失敗："+a.error)},n.readAsText(t)};window.FC.exportAll=function(){const e=_(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),o=document.createElement("a");o.href=n,o.download="全班進度.json",o.click(),URL.revokeObjectURL(n)};window.FC.speak=function(){const e=V(c.scenarioId);e&&O(e)};window.FC.speakOpt=function(e){const t=V(c.scenarioId);if(!t)return;const n=t.options.find(o=>o.id===e);if(n){const{speak:o}=window._fcAudio||{};o&&o(n.text)}};window.FC.speakCreeds=function(){var e;(e=c.resultData)!=null&&e.creeds&&L(c.resultData.creeds)};window.FC.toggleVoice=function(e){const t=!k();M(t),e.classList.toggle("on",t)};window.FC.setFontSize=function(e){localStorage.setItem("fc_font_size",e),v();const t=document.querySelector('[data-for="fs"]');t&&(t.textContent=e<=18?"小":e<=22?"中":"大")};window.FC.setLineHeight=function(e){localStorage.setItem("fc_line_height",e),v();const t=document.querySelector('[data-for="lh"]');t&&(t.textContent=parseFloat(e).toFixed(1))};window.FC.setSpacing=function(e){localStorage.setItem("fc_spacing",e),v(),["narrow","medium","wide"].forEach(t=>{const n=document.getElementById("sp-"+t);n&&(n.className="btn "+(t===e?"btn-primary":"btn-outline"))})};window.FC.setSpeed=function(e){localStorage.setItem("fc_tts_speed",e);const t=document.querySelector('[data-for="speed"]');t&&(t.textContent=parseFloat(e).toFixed(2)+"x")};window.FC.resetSettings=function(){ie(),d()};window.FC.exportMyData=function(){const e=re();if(!e)return;const t=Y(e),n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download=`progress_${e}.json`,i.click(),URL.revokeObjectURL(o)};window.FC.importMyData=function(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{var i;const n=(i=t.target.files)==null?void 0:i[0];if(!n)return;const o=new FileReader;o.onload=a=>{const r=A(a.target.result);alert(r.ok?"匯入成功！":"匯入失敗："+r.error),r.ok&&d()},o.readAsText(n)},e.click()};function Ke(){document.querySelectorAll(".student-name").forEach((e,t)=>{const n=_();n[t]&&(e.textContent=n[t].name)})}function d(){let e="";try{switch(c.view){case"student-select":e=$e();break;case"subject-select":e=Pe();break;case"login":e=Ie();break;case"teacher":e=He(),Ke();break;case"home":e=me(c.subjectId);break;case"topic":e=he(c.topicId,c.subjectId);break;case"play":e=ge(c.scenarioId,c.subjectId);break;case"result":e=pe(c.resultData,c.subjectId);break;case"progress":e=ue(c.subjectId);break;case"settings":e=fe();break;default:e='<div class="container"><p>頁面不存在</p></div>'}I.innerHTML=e}catch(t){console.error("RENDER ERROR:",t.message,t.stack),I.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+t.message+`
`+(t.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}}se(xe);try{d()}catch(e){console.error("RENDER ERROR:",e.message,e.stack),I.innerHTML=`<pre style="color:red;padding:20px">[FC] Render Error:
`+e.message+`
`+(e.stack||"").split(`
`).slice(0,5).join(`
`)+"</pre>"}
